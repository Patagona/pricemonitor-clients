...
class CompaniesApi(object):
    ...
    def add_company_contract(self, company_id, create_contract_request, **kwargs):  # noqa: E501
        """Add contract for given company  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_company_contract(company_id, create_contract_request, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param int company_id: (required)
        :param CreateContractRequest create_contract_request: Contract to be added (required)
        ...
        return self.add_company_contract_with_http_info(company_id, create_contract_request, **kwargs)  # noqa: E501

    def add_company_contract_with_http_info(self, company_id, create_contract_request, **kwargs):  # noqa: E501
        """Add contract for given company  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.add_company_contract_with_http_info(company_id, create_contract_request, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('create_contract_request' not in local_var_params or  # noqa: E501
                                                        local_var_params['create_contract_request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `create_contract_request` when calling `add_company_contract`")  # noqa: E501
        ...
        body_params = None
        if 'create_contract_request' in local_var_params:
            body_params = local_var_params['create_contract_request']
        # HTTP header `Accept`
