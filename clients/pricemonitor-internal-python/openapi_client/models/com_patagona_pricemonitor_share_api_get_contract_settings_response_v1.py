...
class ComPatagonaPricemonitorShareApiGetContractSettingsResponseV1(object):
    ...
    def __init__(self, name=None, expiration_date=None, portals=None, include_delivery_costs=None, features=None, image_tag=None, company=None, id=None, currency=None, type=None, sid=None, active=None, local_vars_configuration=None):  # noqa: E501
