...
class ComPatagonaPricemonitorShareApiPutAdminContractSettingsBody(object):
    ...
    def __init__(self, name=None, expiration_date=None, portals=None, features=None, id=None, type=None, sid=None, active=None, local_vars_configuration=None):  # noqa: E501
