...
[**vendors_per_domain_manufacturer_v2**](OffersApi.md#vendors_per_domain_manufacturer_v2) | **POST** /api/2/m/contracts/{contractId}/result/vendors/domaindistribution | 
...
body = None # object | This is a generated entry and needs to be described. (optional)
    ...
    try:
        ...
        print("Exception when calling OffersApi->post_offers_vendor_v2: %s\n" % e)
```
...
body = None # object | This is a generated entry and needs to be described. (optional)
    ...
    try:
        ...
        print("Exception when calling OffersApi->vendors_per_domain_manufacturer_v2: %s\n" % e)
```
