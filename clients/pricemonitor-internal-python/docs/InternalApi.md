...
post_offer_statistics_request = openapi_client.PostOfferStatisticsRequest() # PostOfferStatisticsRequest | 
...
> ComPatagonaPricemonitorShareApiPricesByDayByProductIdResponseV2 prices_by_day_by_product_id_manufacturer_v2(contract_id, product_id, com_patagona_pricemonitor_share_api_prices_by_day_by_product_id_request_v2=com_patagona_pricemonitor_share_api_prices_by_day_by_product_id_request_v2)
...
[**ComPatagonaPricemonitorShareApiPricesByDayByProductIdResponseV2**](ComPatagonaPricemonitorShareApiPricesByDayByProductIdResponseV2.md)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    contract_id = 'qbcxvb' # str | ID of the contract
list_type = 'list_type_example' # str | 
and_offer_filter = [openapi_client.AndOfferFilter()] # list[AndOfferFilter] | List of the filter that needs to be considered to ignore the individual offers. (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.InternalApi(api_client)
    contract_id = 'qbcxvb' # str | ID of the contract
query_products_request_v3 = openapi_client.QueryProductsRequestV3() # QueryProductsRequestV3 | The body contains the products query. (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.InternalApi(api_client)
    com_patagona_pricemonitor_share_api_post_new_password_request = openapi_client.ComPatagonaPricemonitorShareApiPostNewPasswordRequest() # ComPatagonaPricemonitorShareApiPostNewPasswordRequest | Request a new password. (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.InternalApi(api_client)
    com_patagona_pricemonitor_share_api_put_reset_password_request = openapi_client.ComPatagonaPricemonitorShareApiPutResetPasswordRequest() # ComPatagonaPricemonitorShareApiPutResetPasswordRequest | Reset a password (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    contract_id = 'qbcxvb' # str | ID of the contract
task_id = 'task_id_example' # str | 
update_task_request_v2 = openapi_client.UpdateTaskRequestV2() # UpdateTaskRequestV2 | The new task object to be written to the database (optional)
