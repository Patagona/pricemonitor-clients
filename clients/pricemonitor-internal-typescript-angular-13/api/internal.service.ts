 ...
 *
 * The version of the OpenAPI document: 0.0.6501
 * 
 *
...
export class InternalService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiV3VendorContractsContractIdSettingsPricingstrategiesScenariosPost(contractId: string, postScenarioStrategyRequest?: PostScenarioStrategyRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<PostScenarioStrategyResponseApiResponse>;
    public apiV3VendorContractsContractIdSettingsPricingstrategiesScenariosPost(contractId: string, postScenarioStrategyRequest?: PostScenarioStrategyRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<PostScenarioStrategyResponseApiResponse>>;
    public apiV3VendorContractsContractIdSettingsPricingstrategiesScenariosPost(contractId: string, postScenarioStrategyRequest?: PostScenarioStrategyRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<PostScenarioStrategyResponseApiResponse>>;
    public apiV3VendorContractsContractIdSettingsPricingstrategiesScenariosPost(contractId: string, postScenarioStrategyRequest?: PostScenarioStrategyRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (contractId === null || contractId === undefined) {
            throw new Error('Required parameter contractId was null or undefined when calling apiV3VendorContractsContractIdSettingsPricingstrategiesScenariosPost.');
        }
