...
export class InternalService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiV3VendorContractsContractIdOrdersStatsQueryPost(contractId: string, pricemonitorPostOrderStatisticsRequestV3: PricemonitorPostOrderStatisticsRequestV3, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<QueryOrderStatisticsV3ApiResponse>;
    public apiV3VendorContractsContractIdOrdersStatsQueryPost(contractId: string, pricemonitorPostOrderStatisticsRequestV3: PricemonitorPostOrderStatisticsRequestV3, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<QueryOrderStatisticsV3ApiResponse>>;
    public apiV3VendorContractsContractIdOrdersStatsQueryPost(contractId: string, pricemonitorPostOrderStatisticsRequestV3: PricemonitorPostOrderStatisticsRequestV3, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<QueryOrderStatisticsV3ApiResponse>>;
    public apiV3VendorContractsContractIdOrdersStatsQueryPost(contractId: string, pricemonitorPostOrderStatisticsRequestV3: PricemonitorPostOrderStatisticsRequestV3, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (contractId === null || contractId === undefined) {
            throw new Error('Required parameter contractId was null or undefined when calling apiV3VendorContractsContractIdOrdersStatsQueryPost.');
        }
        if (pricemonitorPostOrderStatisticsRequestV3 === null || pricemonitorPostOrderStatisticsRequestV3 === undefined) {
            throw new Error('Required parameter pricemonitorPostOrderStatisticsRequestV3 was null or undefined when calling apiV3VendorContractsContractIdOrdersStatsQueryPost.');
        }
