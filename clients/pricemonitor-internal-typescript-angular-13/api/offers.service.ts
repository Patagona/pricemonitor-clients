...
export class OffersService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public postOffersInABulkVendorV2(contractId: string, pricemonitorPostProductOfferRequest: Array<PricemonitorPostProductOfferRequest>, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<BooleanBulkApiResponse>;
    public postOffersInABulkVendorV2(contractId: string, pricemonitorPostProductOfferRequest: Array<PricemonitorPostProductOfferRequest>, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<BooleanBulkApiResponse>>;
    public postOffersInABulkVendorV2(contractId: string, pricemonitorPostProductOfferRequest: Array<PricemonitorPostProductOfferRequest>, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<BooleanBulkApiResponse>>;
