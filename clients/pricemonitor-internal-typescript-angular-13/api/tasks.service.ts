...
export class TasksService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateTaskVendorV2(contractId: string, taskId: string, updateTaskRequestV2: UpdateTaskRequestV2, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/plain', context?: HttpContext}): Observable<UpdateTaskRequestV2>;
    public updateTaskVendorV2(contractId: string, taskId: string, updateTaskRequestV2: UpdateTaskRequestV2, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/plain', context?: HttpContext}): Observable<HttpResponse<UpdateTaskRequestV2>>;
    public updateTaskVendorV2(contractId: string, taskId: string, updateTaskRequestV2: UpdateTaskRequestV2, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | 'text/plain', context?: HttpContext}): Observable<HttpEvent<UpdateTaskRequestV2>>;
    public updateTaskVendorV2(contractId: string, taskId: string, updateTaskRequestV2: UpdateTaskRequestV2, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json' | 'text/plain', context?: HttpContext}): Observable<any> {
        if (contractId === null || contractId === undefined) {
