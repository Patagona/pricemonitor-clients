    ...
    def make_instance(self, include_optional):
        ...
        if include_optional :
            return PostAccountResponseV3ApiResponse(
                data = pricemonitor_api_client.models.com/patagona/pricemonitor/share/api/post_account_response_v3.com.patagona.pricemonitor.share.api.PostAccountResponseV3(
                    id = 1.337, 
                    name = '0', 
                    email = '0', )
            )
