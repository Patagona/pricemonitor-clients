...
class ComPatagonaPricemonitorShareApiPriceSimulationBulkRequestV3(object):
    ...
    def __init__(self, strategy_builder=None, simulation_requests=None, simulation_timestamp=None, calculation_timestamp=None, data_time_range=None, own_shops=None, local_vars_configuration=None):  # noqa: E501
    ...
    def simulation_timestamp(self):
        """Gets the simulation_timestamp of this ComPatagonaPricemonitorShareApiPriceSimulationBulkRequestV3.  # noqa: E501

        If provided, then strategies act as if `simulationTimestamp` is the current date and time. This can be useful for testing time based strategies. If not provided, it will try to fall back to `calculationTimestamp`. If not provided and `calculationTimestamp` is also not provided, the current timestamp will be used.  # noqa: E501

        :return: The simulation_timestamp of this ComPatagonaPricemonitorShareApiPriceSimulationBulkRequestV3.  # noqa: E501
        :rtype: datetime
        """
    ...
    def simulation_timestamp(self, simulation_timestamp):
        """Sets the simulation_timestamp of this ComPatagonaPricemonitorShareApiPriceSimulationBulkRequestV3.

        If provided, then strategies act as if `simulationTimestamp` is the current date and time. This can be useful for testing time based strategies. If not provided, it will try to fall back to `calculationTimestamp`. If not provided and `calculationTimestamp` is also not provided, the current timestamp will be used.  # noqa: E501

        :param simulation_timestamp: The simulation_timestamp of this ComPatagonaPricemonitorShareApiPriceSimulationBulkRequestV3.  # noqa: E501
        :type: datetime
        """
    ...
    def calculation_timestamp(self):
        ...
        Timestamp of the original price calculation. Can be used to reproduce a price calculation. This timestamp is used to retrieve product tags, which we store for each successful price calculation.  # noqa: E501
