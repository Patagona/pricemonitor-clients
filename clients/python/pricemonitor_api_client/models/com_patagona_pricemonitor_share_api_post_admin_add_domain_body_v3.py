...
class ComPatagonaPricemonitorShareApiPostAdminAddDomainBodyV3(object):
    ...
    def __init__(self, domain=None, offer_sources=None, local_vars_configuration=None):  # noqa: E501
    ...
    def domain(self):
        ...
        the domain being added. Allowed domain pattern: \"<domain-name>.<top-level-domain>\". Example:\"google.com\", \"amazon.co.uk\" (valid), \"_google_com\" (invalid). For omnia custom monitoring, the domain name must be prefixed with \"omnia.custom.spidering.\"  # noqa: E501
    ...
    def offer_sources(self):
        ...
        sources of offers on this domain. Allowed sources: \"DEFAULT_MONITORING\", \"CUSTOM_MONITORING\", \"OMNIA_CUSTOM_SPIDERING\", \"PUSH_API\", \"OTHER\" @example domain = \"google.de\", offerSources = Set(\"DEFAULT_MONITORING\")  # noqa: E501
