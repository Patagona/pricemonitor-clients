...
class Job(object):
    ...
    def type(self):
        ...
        The types are fixed and defined in the scheduler code.   # noqa: E501
    ...
    def type(self, type):
        ...
        allowed_values = ["ShopIntegrationUpdateProductsJob", "ShopIntegrationStartShopSyncJob", "MonitoringJob", "PreprocessingJob", "ReportJob", "ProductImportJob", "PricewatchJob"]  # noqa: E501
    ...
    def schedule(self):
        ...
        See [CRON spec](https://www.alonsodomin.me/cron4s/userguide/index.html)  Only valid CRON expressions are allowed. Extra expressions from Dkron, e.g. \"@every 5s\", are not allowed.   # noqa: E501
