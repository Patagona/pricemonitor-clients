...
class ComPatagonaPricemonitorShareApiProductPriceDumpingStats(object):
    ...
    def __init__(self, initiated_price_dumpings=None, potentially_initiated_price_dumpings=None, unique_product_initiated_price_dumpings=None, unique_product_potentially_initiated_price_dumpings=None, local_vars_configuration=None):  # noqa: E501
