...
class ComPatagonaPricemonitorShareApiProductPriceSimulationOutcome(object):
    ...
    """
    openapi_types = {
        'original_offers': 'list[ComPatagonaPricemonitorShareApiProductPriceSimulationOutcomeOriginalOffers]',
    ...
    def original_offers(self):
        ...
        :rtype: list[ComPatagonaPricemonitorShareApiProductPriceSimulationOutcomeOriginalOffers]
        """
    ...
    def original_offers(self, original_offers):
        ...
        :type: list[ComPatagonaPricemonitorShareApiProductPriceSimulationOutcomeOriginalOffers]
        """
