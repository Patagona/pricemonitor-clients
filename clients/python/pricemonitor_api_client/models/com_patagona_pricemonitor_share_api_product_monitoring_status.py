...
class ComPatagonaPricemonitorShareApiProductMonitoringStatus(object):
    ...
    openapi_types = {
        'product_id': 'float',
        'status_on_domain': 'list[ComPatagonaPricemonitorShareApiProductMonitoringStatusStatusOnDomain]'
    }
    ...
    def status_on_domain(self):
        ...
        :rtype: list[ComPatagonaPricemonitorShareApiProductMonitoringStatusStatusOnDomain]
        """
    ...
    def status_on_domain(self, status_on_domain):
        ...
        :type: list[ComPatagonaPricemonitorShareApiProductMonitoringStatusStatusOnDomain]
        """
