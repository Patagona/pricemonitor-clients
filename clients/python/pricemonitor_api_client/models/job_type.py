...
class JobType(object):
    ...
    allowable_values = [SHOPINTEGRATIONUPDATEPRODUCTSJOB, SHOPINTEGRATIONSTARTSHOPSYNCJOB, MONITORINGJOB, PREPROCESSINGJOB, REPORTJOB, PRODUCTIMPORTJOB, PRICEWATCHJOB]  # noqa: E501
