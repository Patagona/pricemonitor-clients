...
class UserSignupRequest(object):
    ...
    def __init__(self, email=None, name=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this UserSignupRequest.  # noqa: E501


        :return: The name of this UserSignupRequest.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this UserSignupRequest.


        :param name: The name of this UserSignupRequest.  # noqa: E501
        :type: str
        """
