...
class ComPatagonaPricemonitorShareApiGetFeatureFlagResponse(object):
    ...
    def __init__(self, flag_name=None, updated_at=None, description=None, created_at=None, flag_key=None, local_vars_configuration=None):  # noqa: E501
    ...
    @property
    def flag_name(self):
        """Gets the flag_name of this ComPatagonaPricemonitorShareApiGetFeatureFlagResponse.  # noqa: E501


        :return: The flag_name of this ComPatagonaPricemonitorShareApiGetFeatureFlagResponse.  # noqa: E501
        :rtype: str
        """
    ...
    def flag_name(self, flag_name):
        """Sets the flag_name of this ComPatagonaPricemonitorShareApiGetFeatureFlagResponse.


        :param flag_name: The flag_name of this ComPatagonaPricemonitorShareApiGetFeatureFlagResponse.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and flag_name is None:  # noqa: E501
            raise ValueError("Invalid value for `flag_name`, must not be `None`")  # noqa: E501
