...
class ComPatagonaPricemonitorShareApiRoundingPriceRecommendationResult(object):
    ...
    openapi_types = {
        ...
        'adjust_to_next_reachable_price_step': 'bool',
        'node_id': 'float'
    }
    ...
    attribute_map = {
        ...
        'adjust_to_next_reachable_price_step': 'adjustToNextReachablePriceStep',
        'node_id': 'nodeId'
    }

    def __init__(self, own_offers=None, competitor_offers=None, price_steps=None, step_selection=None, min_price_boundary=None, original_price_recommendation=None, unit_price_recommendation=None, max_price_boundary=None, adjust_to_next_reachable_price_step=None, node_id=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._price_steps = None
        self._step_selection = None
        ...
        self._adjust_to_next_reachable_price_step = None
        self._node_id = None
        ...
        self.step_selection = step_selection
        ...
        if adjust_to_next_reachable_price_step is not None:
            self.adjust_to_next_reachable_price_step = adjust_to_next_reachable_price_step
    ...
    @property
    def price_steps(self):
        """Gets the price_steps of this ComPatagonaPricemonitorShareApiRoundingPriceRecommendationResult.  # noqa: E501

        List of values to round against. They are in unit's of cent (100th of the base currency). They are defined as strings and may contain leading zeroes to indicate allowed increments. For example:<br>                    - [\"5\"] allows prices of 0.05€, 0.15€, 0.25€, 0.35€, ... (increments of 10 cents)<br>                    - [\"05\"] allows prices of 0.05€, 1.05€, 2.05€, 3.05€ ... (increments of 100 cents)<br>                    - [\"00\", \"50\"] allows prices of 0.50€, 1.00€, 1.50€, 2.00€  # noqa: E501

        :return: The price_steps of this ComPatagonaPricemonitorShareApiRoundingPriceRecommendationResult.  # noqa: E501
        :rtype: list[str]
        """
        return self._price_steps

    @price_steps.setter
    def price_steps(self, price_steps):
        """Sets the price_steps of this ComPatagonaPricemonitorShareApiRoundingPriceRecommendationResult.

        List of values to round against. They are in unit's of cent (100th of the base currency). They are defined as strings and may contain leading zeroes to indicate allowed increments. For example:<br>                    - [\"5\"] allows prices of 0.05€, 0.15€, 0.25€, 0.35€, ... (increments of 10 cents)<br>                    - [\"05\"] allows prices of 0.05€, 1.05€, 2.05€, 3.05€ ... (increments of 100 cents)<br>                    - [\"00\", \"50\"] allows prices of 0.50€, 1.00€, 1.50€, 2.00€  # noqa: E501

        :param price_steps: The price_steps of this ComPatagonaPricemonitorShareApiRoundingPriceRecommendationResult.  # noqa: E501
        :type: list[str]
        """
        if self.local_vars_configuration.client_side_validation and price_steps is None:  # noqa: E501
            raise ValueError("Invalid value for `price_steps`, must not be `None`")  # noqa: E501

        self._price_steps = price_steps

    @property
    def step_selection(self):
        """Gets the step_selection of this ComPatagonaPricemonitorShareApiRoundingPriceRecommendationResult.  # noqa: E501

        Defines how to select the price step to round to. Allowed values are: `nextLower`, `nextHigher` and `closest`  # noqa: E501

        :return: The step_selection of this ComPatagonaPricemonitorShareApiRoundingPriceRecommendationResult.  # noqa: E501
        :rtype: str
        """
        return self._step_selection

    @step_selection.setter
    def step_selection(self, step_selection):
        """Sets the step_selection of this ComPatagonaPricemonitorShareApiRoundingPriceRecommendationResult.

        Defines how to select the price step to round to. Allowed values are: `nextLower`, `nextHigher` and `closest`  # noqa: E501

        :param step_selection: The step_selection of this ComPatagonaPricemonitorShareApiRoundingPriceRecommendationResult.  # noqa: E501
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and step_selection is None:  # noqa: E501
            raise ValueError("Invalid value for `step_selection`, must not be `None`")  # noqa: E501

        self._step_selection = step_selection
    ...
    @property
    def adjust_to_next_reachable_price_step(self):
        """Gets the adjust_to_next_reachable_price_step of this ComPatagonaPricemonitorShareApiRoundingPriceRecommendationResult.  # noqa: E501

        Implements the behavior that happens when the original price calculation is in the min-/max price  boundary and the rounding would cause it to violate the price boundary. If set to true, the price  step will be adjusted to the next reachable price step. Defaults to false, in which case the  original price recommendation will be used as the fallback.  # noqa: E501

        :return: The adjust_to_next_reachable_price_step of this ComPatagonaPricemonitorShareApiRoundingPriceRecommendationResult.  # noqa: E501
        :rtype: bool
        """
        return self._adjust_to_next_reachable_price_step

    @adjust_to_next_reachable_price_step.setter
    def adjust_to_next_reachable_price_step(self, adjust_to_next_reachable_price_step):
        """Sets the adjust_to_next_reachable_price_step of this ComPatagonaPricemonitorShareApiRoundingPriceRecommendationResult.

        Implements the behavior that happens when the original price calculation is in the min-/max price  boundary and the rounding would cause it to violate the price boundary. If set to true, the price  step will be adjusted to the next reachable price step. Defaults to false, in which case the  original price recommendation will be used as the fallback.  # noqa: E501

        :param adjust_to_next_reachable_price_step: The adjust_to_next_reachable_price_step of this ComPatagonaPricemonitorShareApiRoundingPriceRecommendationResult.  # noqa: E501
        :type: bool
        """

        self._adjust_to_next_reachable_price_step = adjust_to_next_reachable_price_step
