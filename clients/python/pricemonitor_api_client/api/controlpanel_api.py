...
class ControlpanelApi(object):
    ...
    def controlpanel_api_companies_get(self, start, limit, **kwargs):  # noqa: E501
        """Get a list of all companies  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.controlpanel_api_companies_get(start, limit, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param int start: Start of the pagination (required)
        :param int limit: Number of elements per page (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.controlpanel_api_companies_get_with_http_info(start, limit, **kwargs)  # noqa: E501

    def controlpanel_api_companies_get_with_http_info(self, start, limit, **kwargs):  # noqa: E501
        """Get a list of all companies  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.controlpanel_api_companies_get_with_http_info(start, limit, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('start' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `start` when calling `controlpanel_api_companies_get`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('limit' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `limit` when calling `controlpanel_api_companies_get`")  # noqa: E501
