...
class ControlpanelApi(object):
    ...
    def create_feature_flag(self, com_patagona_pricemonitor_share_api_post_feature_flag_request, **kwargs):  # noqa: E501
        ...
        **🔒 INTERNAL:** Creates a new feature flag in the system.  Feature flags must have a unique key that follows the pattern `[a-zA-Z0-9_-]+` and cannot exceed 128 characters in length.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def delete_feature_flag_with_http_info(self, key, **kwargs):  # noqa: E501
        ...
        **🔒 INTERNAL:** Deletes a feature flag from the system (soft delete).  The feature flag is marked as deleted but preserved in the database for audit purposes. Once deleted, the flag key becomes unavailable for new flags.   # noqa: E501
        ...
        if self.api_client.client_side_validation and 'key' in local_var_params and not re.search(r'^[a-zA-Z0-9_-]+$', local_var_params['key']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `key` when calling `delete_feature_flag`, must conform to the pattern `/^[a-zA-Z0-9_-]+$/`")  # noqa: E501
        collection_formats = {}
    ...
    def get_feature_flag_by_key_with_http_info(self, key, **kwargs):  # noqa: E501
        ...
        **🔒 INTERNAL:** Retrieves a specific feature flag by its key.  Returns the feature flag configuration including metadata such as creation and update timestamps.   # noqa: E501
        ...
        if self.api_client.client_side_validation and 'key' in local_var_params and not re.search(r'^[a-zA-Z0-9_-]+$', local_var_params['key']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `key` when calling `get_feature_flag_by_key`, must conform to the pattern `/^[a-zA-Z0-9_-]+$/`")  # noqa: E501
        collection_formats = {}
    ...
    def post_admin_add_domain_v3(self, **kwargs):  # noqa: E501
        """Add domain  # noqa: E501

        **🔒 INTERNAL:** Adds a new domain to the system for price monitoring.  This administrative operation creates a new domain configuration with the specified offer sources and monitoring capabilities.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_admin_add_domain_v3(async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param ComPatagonaPricemonitorShareApiPostAdminAddDomainBodyV3 com_patagona_pricemonitor_share_api_post_admin_add_domain_body_v3: The domain configuration to be added, including offer sources and monitoring settings
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.post_admin_add_domain_v3_with_http_info(**kwargs)  # noqa: E501

    def post_admin_add_domain_v3_with_http_info(self, **kwargs):  # noqa: E501
        """Add domain  # noqa: E501

        **🔒 INTERNAL:** Adds a new domain to the system for price monitoring.  This administrative operation creates a new domain configuration with the specified offer sources and monitoring capabilities.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_admin_add_domain_v3_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_admin_add_domain_v3" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
    ...
    def put_admin_domain_control_panel_v3(self, domain, **kwargs):  # noqa: E501
        ...
        **🔒 INTERNAL:** Updates an existing domain configuration or creates a new domain if it doesn't exist.  This operation supports both creation and modification of domain configurations, allowing administrative management of supported monitoring domains.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param async_req bool: execute request asynchronously
        :param str domain: Fully qualified domain name for the target marketplace or shop (required)
        :param ComPatagonaPricemonitorShareApiPutAdminDomainRequestV3 com_patagona_pricemonitor_share_api_put_admin_domain_request_v3: The domain configuration to be updated or created, including offer sources and monitoring settings
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def put_admin_domain_control_panel_v3_with_http_info(self, domain, **kwargs):  # noqa: E501
        ...
        **🔒 INTERNAL:** Updates an existing domain configuration or creates a new domain if it doesn't exist.  This operation supports both creation and modification of domain configurations, allowing administrative management of supported monitoring domains.   # noqa: E501
        ...
        if self.api_client.client_side_validation and 'domain' in local_var_params and not re.search(r'^[a-zA-Z0-9.-]+\.[a-zA-Z]{2,}$', local_var_params['domain']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `domain` when calling `put_admin_domain_control_panel_v3`, must conform to the pattern `/^[a-zA-Z0-9.-]+\.[a-zA-Z]{2,}$/`")  # noqa: E501
        collection_formats = {}
    ...
    def update_feature_flag_with_http_info(self, key, com_patagona_pricemonitor_share_api_put_feature_flag_request, **kwargs):  # noqa: E501
        ...
        **🔒 INTERNAL:** Updates an existing feature flag's name and description.  The feature flag key cannot be changed after creation. Only the display name and description can be updated.   # noqa: E501
        ...
        if self.api_client.client_side_validation and 'key' in local_var_params and not re.search(r'^[a-zA-Z0-9_-]+$', local_var_params['key']):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `key` when calling `update_feature_flag`, must conform to the pattern `/^[a-zA-Z0-9_-]+$/`")  # noqa: E501
        collection_formats = {}
