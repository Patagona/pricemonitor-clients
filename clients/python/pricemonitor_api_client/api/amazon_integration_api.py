...
class AmazonIntegrationApi(object):
    ...
    def get_authorization_status_vendor_v3_with_http_info(self, company_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'company_id' in local_var_params and local_var_params['company_id'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `company_id` when calling `get_authorization_status_vendor_v3`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def get_marketplace_activation_status_with_http_info(self, marketplace_country_code, company_id, contract_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'company_id' in local_var_params and local_var_params['company_id'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `company_id` when calling `get_marketplace_activation_status`, must be a value greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and ('contract_id' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `contract_id` when calling `get_marketplace_activation_status`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def post_activate_marketplace_vendor_v3_with_http_info(self, company_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'company_id' in local_var_params and local_var_params['company_id'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `company_id` when calling `post_activate_marketplace_vendor_v3`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def post_authorize_seller_vendor_v3_with_http_info(self, company_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'company_id' in local_var_params and local_var_params['company_id'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `company_id` when calling `post_authorize_seller_vendor_v3`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
