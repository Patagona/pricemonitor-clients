...
class FeedsApi(object):
    ...
    def exclude_fetched_feed_data_with_http_info(self, contract_id, feed_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('contract_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['contract_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `contract_id` when calling `exclude_fetched_feed_data`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def get_feed_with_http_info(self, contract_id, feed_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('contract_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['contract_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `contract_id` when calling `get_feed`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def get_feed_export(self, contract_id, feed_id, file_name, **kwargs):  # noqa: E501
        ...
        Downloads a file containing all the data from the specified feed.  Feeds are price recommendation centric and can be enriched with offer or product information. The export format (JSON or CSV) is determined by the request's Accept header.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_feed_export_with_http_info(self, contract_id, feed_id, file_name, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('contract_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['contract_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `contract_id` when calling `get_feed_export`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def get_feed_export_delta_with_http_info(self, contract_id, feed_id, file_name, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('contract_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['contract_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `contract_id` when calling `get_feed_export_delta`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def get_feeds_with_http_info(self, contract_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('contract_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['contract_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `contract_id` when calling `get_feeds`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
