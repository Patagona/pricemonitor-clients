...
class SettingsApi(object):
    ...
    def get_callbacks_with_http_info(self, contract_id, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(ComPatagonaPricemonitorShareApiCallbacks, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if self.api_client.client_side_validation and ('contract_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['contract_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `contract_id` when calling `get_callbacks`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ComPatagonaPricemonitorShareApiCallbacks',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def get_callbacks_vendor_v2(self, contract_id, **kwargs):  # noqa: E501
        ...
        Retrieve all callbacks for the given contract.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_callbacks_vendor_v2_with_http_info(self, contract_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('contract_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['contract_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `contract_id` when calling `get_callbacks_vendor_v2`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def get_domains_vendor_v2_with_http_info(self, contract_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('contract_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['contract_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `contract_id` when calling `get_domains_vendor_v2`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def get_monitoring_settings_manufacturer_v2_with_http_info(self, contract_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('contract_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['contract_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `contract_id` when calling `get_monitoring_settings_manufacturer_v2`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def put_callbacks(self, contract_id, com_patagona_pricemonitor_share_api_callbacks, **kwargs):  # noqa: E501
        """Update callbacks [manufacturer]  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_callbacks(contract_id, com_patagona_pricemonitor_share_api_callbacks, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str contract_id: Unique identifier of the contract (required)
        :param ComPatagonaPricemonitorShareApiCallbacks com_patagona_pricemonitor_share_api_callbacks: Callbacks (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.put_callbacks_with_http_info(contract_id, com_patagona_pricemonitor_share_api_callbacks, **kwargs)  # noqa: E501

    def put_callbacks_with_http_info(self, contract_id, com_patagona_pricemonitor_share_api_callbacks, **kwargs):  # noqa: E501
        """Update callbacks [manufacturer]  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_callbacks_with_http_info(contract_id, com_patagona_pricemonitor_share_api_callbacks, async_req=True)
        >>> result = thread.get()
        ...
        all_params = [
            'contract_id',
            'com_patagona_pricemonitor_share_api_callbacks'
        ]
        all_params.extend(
            [
                'async_req',
        ...
        # verify the required parameter 'com_patagona_pricemonitor_share_api_callbacks' is set
        if self.api_client.client_side_validation and ('com_patagona_pricemonitor_share_api_callbacks' not in local_var_params or  # noqa: E501
                                                        local_var_params['com_patagona_pricemonitor_share_api_callbacks'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `com_patagona_pricemonitor_share_api_callbacks` when calling `put_callbacks`")  # noqa: E501

        if self.api_client.client_side_validation and ('contract_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['contract_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `contract_id` when calling `put_callbacks`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        body_params = None
        if 'com_patagona_pricemonitor_share_api_callbacks' in local_var_params:
            body_params = local_var_params['com_patagona_pricemonitor_share_api_callbacks']
        # HTTP header `Content-Type`
        header_params['Content-Type'] = self.api_client.select_header_content_type(  # noqa: E501
            ['application/json'])  # noqa: E501
    ...
    def put_callbacks_vendor_v2(self, contract_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str contract_id: Unique identifier of the contract (required)
        :param ComPatagonaPricemonitorShareApiCallbacks com_patagona_pricemonitor_share_api_callbacks: The request body should contain a list of callbacks to be stored.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def put_callbacks_vendor_v2_with_http_info(self, contract_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('contract_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['contract_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `contract_id` when calling `put_callbacks_vendor_v2`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def put_domains_with_http_info(self, contract_id, request_body, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('contract_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['contract_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `contract_id` when calling `put_domains`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def put_monitoring_settings_manufacturer_v2_with_http_info(self, contract_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('contract_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['contract_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `contract_id` when calling `put_monitoring_settings_manufacturer_v2`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
