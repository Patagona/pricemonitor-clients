...
class LookerApi(object):
    ...
    def post_embed_sso_url_vendor_with_http_info(self, contract_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('contract_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['contract_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `contract_id` when calling `post_embed_sso_url_vendor`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
