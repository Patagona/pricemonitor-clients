...
class StrategyApi(object):
    ...
    def get_pricing_strategy_history(self, contract_id, **kwargs):  # noqa: E501
        """Get all strategy versions metadata for contract  # noqa: E501

        Retrieves a list of metadata for all pricing strategy versions associated with a specific contract.  This endpoint provides version history information including creation dates, modification timestamps, and strategy metadata for tracking changes over time.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_pricing_strategy_history(contract_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.get_pricing_strategy_history_with_http_info(contract_id, **kwargs)  # noqa: E501

    def get_pricing_strategy_history_with_http_info(self, contract_id, **kwargs):  # noqa: E501
        """Get all strategy versions metadata for contract  # noqa: E501

        Retrieves a list of metadata for all pricing strategy versions associated with a specific contract.  This endpoint provides version history information including creation dates, modification timestamps, and strategy metadata for tracking changes over time.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_pricing_strategy_history_with_http_info(contract_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method get_pricing_strategy_history" % key
                )
        ...
        if self.api_client.client_side_validation and ('contract_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `contract_id` when calling `get_pricing_strategy_history`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('contract_id' in local_var_params and  # noqa: E501
            ...
            raise ApiValueError("Invalid value for parameter `contract_id` when calling `get_pricing_strategy_history`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/api/v3/vendor/contracts/{contractId}/settings/pricingstrategies/history', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
