...
class StrategyApi(object):
    ...
    def api_v3_vendor_contracts_contract_id_settings_pricingstrategies_history_get(self, contract_id, **kwargs):  # noqa: E501
        """Get a list of metadata of all strategy versions for a contract  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v3_vendor_contracts_contract_id_settings_pricingstrategies_history_get(contract_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_v3_vendor_contracts_contract_id_settings_pricingstrategies_history_get_with_http_info(contract_id, **kwargs)  # noqa: E501

    def api_v3_vendor_contracts_contract_id_settings_pricingstrategies_history_get_with_http_info(self, contract_id, **kwargs):  # noqa: E501
        """Get a list of metadata of all strategy versions for a contract  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v3_vendor_contracts_contract_id_settings_pricingstrategies_history_get_with_http_info(contract_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method api_v3_vendor_contracts_contract_id_settings_pricingstrategies_history_get" % key
                )
        ...
        if self.api_client.client_side_validation and ('contract_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `contract_id` when calling `api_v3_vendor_contracts_contract_id_settings_pricingstrategies_history_get`")  # noqa: E501
