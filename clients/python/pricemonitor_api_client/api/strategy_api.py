...
class StrategyApi(object):
    ...
    def get_strategy_history_with_http_info(self, contract_id, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(GetRepricingStrategyHistoryV3ApiResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            response_type='GetRepricingStrategyHistoryV3ApiResponse',  # noqa: E501
