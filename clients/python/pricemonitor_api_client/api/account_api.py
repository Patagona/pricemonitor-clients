...
class AccountApi(object):
    ...
    def refresh_access_token(self, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.refresh_access_token_with_http_info(**kwargs)  # noqa: E501

    def refresh_access_token_with_http_info(self, **kwargs):  # noqa: E501
        """Refresh an access token using the refresh token.  # noqa: E501

        An access token, a refresh token and a refresh token id are issued upon valid credentials. See [/api/v3/account/token/access](#/account/requestAccessToken) for more details. When an access token expired, it can be re-issued (or refreshed) using the refresh token and refresh token id, the one obtained upon valid credentials.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.refresh_access_token_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(PostAccessTokenResponseV3ApiResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        all_params = [
            'com_patagona_pricemonitor_share_api_post_refresh_access_token_request_v3'
        ]
        all_params.extend(
            [
                'async_req',
        ...
        body_params = None
        if 'com_patagona_pricemonitor_share_api_post_refresh_access_token_request_v3' in local_var_params:
            body_params = local_var_params['com_patagona_pricemonitor_share_api_post_refresh_access_token_request_v3']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v3/account/token/refresh', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='PostAccessTokenResponseV3ApiResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def request_access_token(self, **kwargs):  # noqa: E501
        """Issues a token which can be used to access protected resources of the Pricemonitor API.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.request_access_token(async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param ComPatagonaPricemonitorShareApiPostAccessTokenRequestV3 com_patagona_pricemonitor_share_api_post_access_token_request_v3: Request body contains credentials i.e email address and password.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.request_access_token_with_http_info(**kwargs)  # noqa: E501

    def request_access_token_with_http_info(self, **kwargs):  # noqa: E501
        """Issues a token which can be used to access protected resources of the Pricemonitor API.  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.request_access_token_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = [
            'com_patagona_pricemonitor_share_api_post_access_token_request_v3'
        ]
        all_params.extend(
            [
                'async_req',
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method request_access_token" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        body_params = None
        if 'com_patagona_pricemonitor_share_api_post_access_token_request_v3' in local_var_params:
            body_params = local_var_params['com_patagona_pricemonitor_share_api_post_access_token_request_v3']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v3/account/token/access', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
