...
class OffersApi(object):
    ...
    def api_v31_manufacturer_contracts_contract_id_offers_stats_query_post(self, contract_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.api_v31_manufacturer_contracts_contract_id_offers_stats_query_post(contract_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.api_v31_manufacturer_contracts_contract_id_offers_stats_query_post_with_http_info(contract_id, **kwargs)  # noqa: E501

    def api_v31_manufacturer_contracts_contract_id_offers_stats_query_post_with_http_info(self, contract_id, **kwargs):  # noqa: E501
        """Query offer statistics per product  # noqa: E501

        This endpoint can be used to query offer statistics (e.g. offer count, average price) grouped by product. Only the most recent market data is considered per product and domain.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v31_manufacturer_contracts_contract_id_offers_stats_query_post_with_http_info(contract_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method api_v31_manufacturer_contracts_contract_id_offers_stats_query_post" % key
                )
        ...
        if self.api_client.client_side_validation and ('contract_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `contract_id` when calling `api_v31_manufacturer_contracts_contract_id_offers_stats_query_post`")  # noqa: E501
    ...
    def api_v31_vendor_contracts_contract_id_offers_stats_query_post(self, contract_id, **kwargs):  # noqa: E501
        """Query offer statistics per product  # noqa: E501

        This endpoint can be used to query offer statistics (e.g. offer count, average price) grouped by product. Only the most recent market data is considered per product and domain.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v31_vendor_contracts_contract_id_offers_stats_query_post(contract_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.api_v31_vendor_contracts_contract_id_offers_stats_query_post_with_http_info(contract_id, **kwargs)  # noqa: E501

    def api_v31_vendor_contracts_contract_id_offers_stats_query_post_with_http_info(self, contract_id, **kwargs):  # noqa: E501
        """Query offer statistics per product  # noqa: E501

        This endpoint can be used to query offer statistics (e.g. offer count, average price) grouped by product. Only the most recent market data is considered per product and domain.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.api_v31_vendor_contracts_contract_id_offers_stats_query_post_with_http_info(contract_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method api_v31_vendor_contracts_contract_id_offers_stats_query_post" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'contract_id' is set
        if self.api_client.client_side_validation and ('contract_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['contract_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `contract_id` when calling `api_v31_vendor_contracts_contract_id_offers_stats_query_post`")  # noqa: E501
