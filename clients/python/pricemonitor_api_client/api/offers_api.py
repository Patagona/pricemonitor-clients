...
class OffersApi(object):
    ...
    def get_complex_offer_filters_vendor_v2_with_http_info(self, contract_id, list_type, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('contract_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['contract_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `contract_id` when calling `get_complex_offer_filters_vendor_v2`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def get_offer_filters_vendor_v2_with_http_info(self, contract_id, list_type, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('contract_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['contract_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `contract_id` when calling `get_offer_filters_vendor_v2`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def get_offer_statistics_manufacturer_v3_with_http_info(self, contract_id, include_delivery_costs, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('contract_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['contract_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `contract_id` when calling `get_offer_statistics_manufacturer_v3`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def get_offers_manufacturer_v3(self, contract_id, **kwargs):  # noqa: E501
        """Get offers for time range  # noqa: E501

        **🔒 INTERNAL:** Retrieves the most recent offers for all products within a specified time range.  This endpoint provides manufacturer contracts with access to offer data across all monitored domains and vendors. The data includes pricing, availability, and vendor information for competitive analysis.  **Performance Notes:** - Results are paginated based on products for optimal performance - Maximum limit of 1,000 products per request - Time range should be kept reasonable for best performance   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_offers_manufacturer_v3(contract_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str contract_id: Unique identifier of the contract (required)
        :param int start: Starting index for pagination (0-based)
        :param int limit: Maximum number of offers to return (max 10,000)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_offers_manufacturer_v3_with_http_info(contract_id, **kwargs)  # noqa: E501

    def get_offers_manufacturer_v3_with_http_info(self, contract_id, **kwargs):  # noqa: E501
        """Get offers for time range  # noqa: E501

        **🔒 INTERNAL:** Retrieves the most recent offers for all products within a specified time range.  This endpoint provides manufacturer contracts with access to offer data across all monitored domains and vendors. The data includes pricing, availability, and vendor information for competitive analysis.  **Performance Notes:** - Results are paginated based on products for optimal performance - Maximum limit of 1,000 products per request - Time range should be kept reasonable for best performance   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_offers_manufacturer_v3_with_http_info(contract_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_offers_manufacturer_v3" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'contract_id' is set
        if self.api_client.client_side_validation and ('contract_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['contract_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `contract_id` when calling `get_offers_manufacturer_v3`")  # noqa: E501

        if self.api_client.client_side_validation and ('contract_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['contract_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `contract_id` when calling `get_offers_manufacturer_v3`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and 'start' in local_var_params and local_var_params['start'] < 0:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `start` when calling `get_offers_manufacturer_v3`, must be a value greater than or equal to `0`")  # noqa: E501
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] > 1000:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `get_offers_manufacturer_v3`, must be a value less than or equal to `1000`")  # noqa: E501
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `get_offers_manufacturer_v3`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def get_offers_shops_manufacturer_v3_with_http_info(self, contract_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('contract_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['contract_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `contract_id` when calling `get_offers_shops_manufacturer_v3`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def get_offers_shops_vendor_v3_with_http_info(self, contract_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('contract_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['contract_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `contract_id` when calling `get_offers_shops_vendor_v3`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def get_offers_vendor_v3(self, contract_id, **kwargs):  # noqa: E501
        """Get offers for timerange  # noqa: E501

        Returns the newest offers for a given time range.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_offers_vendor_v3(contract_id, async_req=True)
        >>> result = thread.get()
        ...
        :param bool include_tags: Whether to return tags of products or not.
        :param datetime start_date: **Start of time range** for data retrieval.  Format: ISO 8601 date-time in UTC (e.g., `2024-01-15T10:30:00Z`)  **Default behavior:** - If omitted and `endDate` is provided: `startDate` = `endDate` - 48 hours - If both omitted: range is `NOW - 48 hours` to `NOW` 
        :param datetime end_date: **End of time range** for data retrieval.  Format: ISO 8601 date-time in UTC (e.g., `2024-01-16T10:30:00Z`)  **Default behavior:** - If omitted and `startDate` is provided: `endDate` = `startDate` + 48 hours - If both omitted: range is `NOW - 48 hours` to `NOW` 
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_offers_vendor_v3_with_http_info(contract_id, **kwargs)  # noqa: E501

    def get_offers_vendor_v3_with_http_info(self, contract_id, **kwargs):  # noqa: E501
        """Get offers for timerange  # noqa: E501

        Returns the newest offers for a given time range.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_offers_vendor_v3_with_http_info(contract_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_offers_vendor_v3" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'contract_id' is set
        if self.api_client.client_side_validation and ('contract_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['contract_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `contract_id` when calling `get_offers_vendor_v3`")  # noqa: E501

        if self.api_client.client_side_validation and ('contract_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['contract_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `contract_id` when calling `get_offers_vendor_v3`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def get_product_filters_by_range_vendor_v2_with_http_info(self, contract_id, list_type, start, limit, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('contract_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['contract_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `contract_id` when calling `get_product_filters_by_range_vendor_v2`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def post_offers_in_a_bulk_vendor_v2(self, contract_id, com_patagona_pricemonitor_share_api_post_product_offer_request, **kwargs):  # noqa: E501
        """Add offers in bulk  # noqa: E501

        This endpoint can be used to provide external offers to Omnia 2.0. It's a bulk endpoint which accepts an array of individual POST offers requests each based on a \"snapshot\" - a unique combination of product, domain, and timestamp for a list of offers.  Validation rules before storage:  1. The product must exist in the contract. 2. Only snapshots newer than those already stored will be accepted. 3. Each domain must use a consistent currency. 4. Duplicate snapshots in the same request are stored once. 5. Conflicting snapshots for the same product + domain + timestamp are all rejected. 6. Offer IDs must be unique across all offers. 7. The domain field must not be empty. 8. Offer prices must be ≥ 0.01, delivery costs must be ≥ 0.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_offers_in_a_bulk_vendor_v2(contract_id, com_patagona_pricemonitor_share_api_post_product_offer_request, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str contract_id: Unique identifier of the contract (required)
        :param list[ComPatagonaPricemonitorShareApiPostProductOfferRequest] com_patagona_pricemonitor_share_api_post_product_offer_request: A list of individual POST offers requests (snapshots) to be stored.  Submit up to 1,000 snapshots per request for optimal performance. Snapshots are validated and processed in the order provided. The response follows the same order.  (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.post_offers_in_a_bulk_vendor_v2_with_http_info(contract_id, com_patagona_pricemonitor_share_api_post_product_offer_request, **kwargs)  # noqa: E501

    def post_offers_in_a_bulk_vendor_v2_with_http_info(self, contract_id, com_patagona_pricemonitor_share_api_post_product_offer_request, **kwargs):  # noqa: E501
        """Add offers in bulk  # noqa: E501

        This endpoint can be used to provide external offers to Omnia 2.0. It's a bulk endpoint which accepts an array of individual POST offers requests each based on a \"snapshot\" - a unique combination of product, domain, and timestamp for a list of offers.  Validation rules before storage:  1. The product must exist in the contract. 2. Only snapshots newer than those already stored will be accepted. 3. Each domain must use a consistent currency. 4. Duplicate snapshots in the same request are stored once. 5. Conflicting snapshots for the same product + domain + timestamp are all rejected. 6. Offer IDs must be unique across all offers. 7. The domain field must not be empty. 8. Offer prices must be ≥ 0.01, delivery costs must be ≥ 0.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_offers_in_a_bulk_vendor_v2_with_http_info(contract_id, com_patagona_pricemonitor_share_api_post_product_offer_request, async_req=True)
        >>> result = thread.get()
        ...
        # verify the required parameter 'com_patagona_pricemonitor_share_api_post_product_offer_request' is set
        if self.api_client.client_side_validation and ('com_patagona_pricemonitor_share_api_post_product_offer_request' not in local_var_params or  # noqa: E501
                                                        local_var_params['com_patagona_pricemonitor_share_api_post_product_offer_request'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `com_patagona_pricemonitor_share_api_post_product_offer_request` when calling `post_offers_in_a_bulk_vendor_v2`")  # noqa: E501

        if self.api_client.client_side_validation and ('contract_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['contract_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `contract_id` when calling `post_offers_in_a_bulk_vendor_v2`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        body_params = None
        if 'com_patagona_pricemonitor_share_api_post_product_offer_request' in local_var_params:
            body_params = local_var_params['com_patagona_pricemonitor_share_api_post_product_offer_request']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
    ...
    def prices_by_day_by_product_id_manufacturer_v2_with_http_info(self, contract_id, product_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('contract_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['contract_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `contract_id` when calling `prices_by_day_by_product_id_manufacturer_v2`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def put_complex_offer_filters_vendor_v2_with_http_info(self, contract_id, list_type, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('contract_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['contract_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `contract_id` when calling `put_complex_offer_filters_vendor_v2`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def put_offer_filters_vendor_v2_with_http_info(self, contract_id, list_type, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('contract_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['contract_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `contract_id` when calling `put_offer_filters_vendor_v2`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def query_offers_stats_manufacturer_v31_with_http_info(self, contract_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('contract_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['contract_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `contract_id` when calling `query_offers_stats_manufacturer_v31`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def query_offers_stats_vendor_v31(self, contract_id, **kwargs):  # noqa: E501
        """Query offer statistics per product  # noqa: E501

        This endpoint can be used to query offer statistics (e.g. offer count, average price) grouped by product. Only the most recent market data is considered per product and domain.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.query_offers_stats_vendor_v31(contract_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.query_offers_stats_vendor_v31_with_http_info(contract_id, **kwargs)  # noqa: E501

    def query_offers_stats_vendor_v31_with_http_info(self, contract_id, **kwargs):  # noqa: E501
        """Query offer statistics per product  # noqa: E501

        This endpoint can be used to query offer statistics (e.g. offer count, average price) grouped by product. Only the most recent market data is considered per product and domain.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.query_offers_stats_vendor_v31_with_http_info(contract_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method query_offers_stats_vendor_v31" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'contract_id' is set
        if self.api_client.client_side_validation and ('contract_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['contract_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `contract_id` when calling `query_offers_stats_vendor_v31`")  # noqa: E501

        if self.api_client.client_side_validation and ('contract_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['contract_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `contract_id` when calling `query_offers_stats_vendor_v31`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/api/v3.1/vendor/contracts/{contractId}/offers/stats/query', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def query_offers_vendor_v3(self, contract_id, product_offers_api_query, **kwargs):  # noqa: E501
        """Query offers [vendor]  # noqa: E501

        Supports complex queries for offers.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.query_offers_vendor_v3(contract_id, product_offers_api_query, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.query_offers_vendor_v3_with_http_info(contract_id, product_offers_api_query, **kwargs)  # noqa: E501

    def query_offers_vendor_v3_with_http_info(self, contract_id, product_offers_api_query, **kwargs):  # noqa: E501
        """Query offers [vendor]  # noqa: E501

        Supports complex queries for offers.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.query_offers_vendor_v3_with_http_info(contract_id, product_offers_api_query, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method query_offers_vendor_v3" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'contract_id' is set
        if self.api_client.client_side_validation and ('contract_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['contract_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `contract_id` when calling `query_offers_vendor_v3`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('product_offers_api_query' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `product_offers_api_query` when calling `query_offers_vendor_v3`")  # noqa: E501

        if self.api_client.client_side_validation and ('contract_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['contract_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `contract_id` when calling `query_offers_vendor_v3`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def stats_manufacturer_v2_with_http_info(self, contract_id, session, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('contract_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['contract_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `contract_id` when calling `stats_manufacturer_v2`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
