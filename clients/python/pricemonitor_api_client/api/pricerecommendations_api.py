...
class PricerecommendationsApi(object):
    ...
    def get_price_recommendation(self, contract_id, start_time, end_time, start, **kwargs):  # noqa: E501
        ...
        Gets all price recommendations for a contract for the specified timerange. Only the newest price recommendations are returned in case of multiple price recommendations per product  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
