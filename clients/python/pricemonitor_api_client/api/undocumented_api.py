...
class UndocumentedApi(object):
    ...
    def save_sales(self, contract_id, **kwargs):  # noqa: E501
        """save_sales  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.save_sales(contract_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.save_sales_with_http_info(contract_id, **kwargs)  # noqa: E501

    def save_sales_with_http_info(self, contract_id, **kwargs):  # noqa: E501
        """save_sales  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.save_sales_with_http_info(contract_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('contract_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['contract_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `contract_id` when calling `save_sales`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/1/{contractId}/products/sales', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
