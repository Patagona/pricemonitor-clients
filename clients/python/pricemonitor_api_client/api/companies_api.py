...
class CompaniesApi(object):
    ...
    def add_company_contract(self, company_id, com_patagona_pricemonitor_share_api_create_contract_request, **kwargs):  # noqa: E501
        ...
        Add a contract for the given company.  # noqa: E501
    ...
    def add_company_contract_with_http_info(self, company_id, com_patagona_pricemonitor_share_api_create_contract_request, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'company_id' in local_var_params and local_var_params['company_id'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `company_id` when calling `add_company_contract`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def create_company(self, body, **kwargs):  # noqa: E501
        ...
        Allows users without a company to create a new company.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_company_contracts(self, company_id, **kwargs):  # noqa: E501
        ...
        Get all contracts for the given company.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_company_contracts_with_http_info(self, company_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'company_id' in local_var_params and local_var_params['company_id'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `company_id` when calling `get_company_contracts`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def get_manufacturer_v3_with_http_info(self, contract_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('contract_id' in local_var_params and  # noqa: E501
                                                        len(local_var_params['contract_id']) < 1):  # noqa: E501
            raise ApiValueError("Invalid value for parameter `contract_id` when calling `get_manufacturer_v3`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def get_user_access_to_contracts_of_company_v3_with_http_info(self, company_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'company_id' in local_var_params and local_var_params['company_id'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `company_id` when calling `get_user_access_to_contracts_of_company_v3`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def get_users_with_http_info(self, company_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'company_id' in local_var_params and local_var_params['company_id'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `company_id` when calling `get_users`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
    ...
    def post_invite_user_to_company_v3(self, company_id, **kwargs):  # noqa: E501
        """Invite a user to a company  # noqa: E501

        Company admin user can invite a user to a company.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_invite_user_to_company_v3(company_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param int company_id: Unique identifier of a company in the system (required)
        :param ComPatagonaPricemonitorShareApiInviteUserToCompanyRequestV3 com_patagona_pricemonitor_share_api_invite_user_to_company_request_v3: User information including email & display name.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: InviteUserToCompanyResponseV3ApiResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        return self.post_invite_user_to_company_v3_with_http_info(company_id, **kwargs)  # noqa: E501

    def post_invite_user_to_company_v3_with_http_info(self, company_id, **kwargs):  # noqa: E501
        """Invite a user to a company  # noqa: E501

        Company admin user can invite a user to a company.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.post_invite_user_to_company_v3_with_http_info(company_id, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(InviteUserToCompanyResponseV3ApiResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        all_params = [
            'company_id',
            'com_patagona_pricemonitor_share_api_invite_user_to_company_request_v3'
        ]
        all_params.extend(
            [
                'async_req',
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method post_invite_user_to_company_v3" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'company_id' is set
        if self.api_client.client_side_validation and ('company_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['company_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `company_id` when calling `post_invite_user_to_company_v3`")  # noqa: E501

        if self.api_client.client_side_validation and 'company_id' in local_var_params and local_var_params['company_id'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `company_id` when calling `post_invite_user_to_company_v3`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        body_params = None
        if 'com_patagona_pricemonitor_share_api_invite_user_to_company_request_v3' in local_var_params:
            body_params = local_var_params['com_patagona_pricemonitor_share_api_invite_user_to_company_request_v3']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
        ...
        return self.api_client.call_api(
            '/api/v3/companies/{companyId}/users', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='InviteUserToCompanyResponseV3ApiResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def put_user_access_to_contracts_of_company_v3_with_http_info(self, company_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and 'company_id' in local_var_params and local_var_params['company_id'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `company_id` when calling `put_user_access_to_contracts_of_company_v3`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
