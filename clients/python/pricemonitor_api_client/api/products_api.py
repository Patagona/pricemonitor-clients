...
class ProductsApi(object):
    ...
    def get_amazon_buybox_product_stats_v3(self, contract_id, **kwargs):  # noqa: E501
        ...
        :param int start: Where to start fetching the amazon buybox statistics. Must be positive. Default value is 0.
    ...
    def get_products(self, contract_id, attributes, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str contract_id: ID of the contract (required)
        :param str attributes: Query string to filter products (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def post_offer_statistics_vendor_query(self, contract_id, post_offer_statistics_request, **kwargs):  # noqa: E501
        """post_offer_statistics_vendor_query  # noqa: E501
