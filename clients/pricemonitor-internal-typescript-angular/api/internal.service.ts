...
import { ComPatagonaPricemonitorShareApiAdminCompanyV2 } from '../model/models';
import { ComPatagonaPricemonitorShareApiContractStats } from '../model/models';
import { ComPatagonaPricemonitorShareApiCreateTaskBodyV2 } from '../model/models';
...
export class InternalService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public controlpanelApiCompaniesGet(start: number, limit: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<ComPatagonaPricemonitorShareApiAdminCompanyV2>;
    public controlpanelApiCompaniesGet(start: number, limit: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<ComPatagonaPricemonitorShareApiAdminCompanyV2>>;
    public controlpanelApiCompaniesGet(start: number, limit: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<ComPatagonaPricemonitorShareApiAdminCompanyV2>>;
    public controlpanelApiCompaniesGet(start: number, limit: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        ...
        return this.httpClient.get<ComPatagonaPricemonitorShareApiAdminCompanyV2>(`${this.configuration.basePath}/controlpanel/api/companies`,
            {
                responseType: <any>responseType,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * Create a new task
     * @param contractId ID of the contract
     * @param comPatagonaPricemonitorShareApiCreateTaskBodyV2 This is a generated entry and needs to be described.
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public createTaskManufacturerV2(contractId: string, comPatagonaPricemonitorShareApiCreateTaskBodyV2?: ComPatagonaPricemonitorShareApiCreateTaskBodyV2, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<GenericTaskWithUrl>;
    public createTaskManufacturerV2(contractId: string, comPatagonaPricemonitorShareApiCreateTaskBodyV2?: ComPatagonaPricemonitorShareApiCreateTaskBodyV2, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<GenericTaskWithUrl>>;
    public createTaskManufacturerV2(contractId: string, comPatagonaPricemonitorShareApiCreateTaskBodyV2?: ComPatagonaPricemonitorShareApiCreateTaskBodyV2, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<GenericTaskWithUrl>>;
    public createTaskManufacturerV2(contractId: string, comPatagonaPricemonitorShareApiCreateTaskBodyV2?: ComPatagonaPricemonitorShareApiCreateTaskBodyV2, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        if (contractId === null || contractId === undefined) {
