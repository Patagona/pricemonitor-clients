...
export class InternalService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getTasksManufacturerV2(contractId: string, taskTypeFilter: Array<string>, taskState: Array<string>, limit: number, includeFailures: boolean, taskIdsFilter?: string, minCreationDate?: string, maxCreationDate?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<object>;
    public getTasksManufacturerV2(contractId: string, taskTypeFilter: Array<string>, taskState: Array<string>, limit: number, includeFailures: boolean, taskIdsFilter?: string, minCreationDate?: string, maxCreationDate?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<object>>;
