...
import { GetVendorShopMappingApiResponse } from '../model/models';
...
export class InternalService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getVendorShopMappingManufacturerV3(contractId: string, vendorId: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<GetVendorShopMappingApiResponse>;
    public getVendorShopMappingManufacturerV3(contractId: string, vendorId: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<GetVendorShopMappingApiResponse>>;
    public getVendorShopMappingManufacturerV3(contractId: string, vendorId: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<GetVendorShopMappingApiResponse>>;
    public getVendorShopMappingManufacturerV3(contractId: string, vendorId: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        ...
        return this.httpClient.get<GetVendorShopMappingApiResponse>(`${this.configuration.basePath}/api/v3/manufacturer/contracts/${encodeURIComponent(String(contractId))}/vendors/${encodeURIComponent(String(vendorId))}`,
            {
                responseType: <any>responseType,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
