...
import { ComPatagonaPricemonitorShareApiContractStats } from '../model/models';
...
import { ComPatagonaPricemonitorShareApiPricesByDayByProductIdRequestV2 } from '../model/models';
import { ComPatagonaPricemonitorShareApiPricesByDayByProductIdResponseV2 } from '../model/models';
...
export class InternalService {
     ...
     * @param comPatagonaPricemonitorShareApiPricesByDayByProductIdRequestV2 Query all known prices for a given day &amp; product ID. Can be filtered by using the selectors.
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public pricesByDayByProductIdManufacturerV2(contractId: string, productId: string, comPatagonaPricemonitorShareApiPricesByDayByProductIdRequestV2?: ComPatagonaPricemonitorShareApiPricesByDayByProductIdRequestV2, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<ComPatagonaPricemonitorShareApiPricesByDayByProductIdResponseV2>;
    public pricesByDayByProductIdManufacturerV2(contractId: string, productId: string, comPatagonaPricemonitorShareApiPricesByDayByProductIdRequestV2?: ComPatagonaPricemonitorShareApiPricesByDayByProductIdRequestV2, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<ComPatagonaPricemonitorShareApiPricesByDayByProductIdResponseV2>>;
    public pricesByDayByProductIdManufacturerV2(contractId: string, productId: string, comPatagonaPricemonitorShareApiPricesByDayByProductIdRequestV2?: ComPatagonaPricemonitorShareApiPricesByDayByProductIdRequestV2, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<ComPatagonaPricemonitorShareApiPricesByDayByProductIdResponseV2>>;
    public pricesByDayByProductIdManufacturerV2(contractId: string, productId: string, comPatagonaPricemonitorShareApiPricesByDayByProductIdRequestV2?: ComPatagonaPricemonitorShareApiPricesByDayByProductIdRequestV2, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        ...
        return this.httpClient.post<ComPatagonaPricemonitorShareApiPricesByDayByProductIdResponseV2>(`${this.configuration.basePath}/api/2/m/contracts/${encodeURIComponent(String(contractId))}/result/pricesbyday/productid/${encodeURIComponent(String(productId))}`,
            comPatagonaPricemonitorShareApiPricesByDayByProductIdRequestV2,
            {
                responseType: <any>responseType,
                withCredentials: this.configuration.withCredentials,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public statsManufacturerV2(contractId: string, session: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<ComPatagonaPricemonitorShareApiContractStats>;
    public statsManufacturerV2(contractId: string, session: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<ComPatagonaPricemonitorShareApiContractStats>>;
    public statsManufacturerV2(contractId: string, session: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<ComPatagonaPricemonitorShareApiContractStats>>;
    public statsManufacturerV2(contractId: string, session: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        ...
        return this.httpClient.get<ComPatagonaPricemonitorShareApiContractStats>(`${this.configuration.basePath}/api/2/m/contracts/${encodeURIComponent(String(contractId))}/result/contract/stats`,
            {
                params: queryParameters,
                responseType: <any>responseType,
                withCredentials: this.configuration.withCredentials,
