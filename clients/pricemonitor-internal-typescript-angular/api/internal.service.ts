...
export class InternalService {
    ...
    /**
     * @param contractId ID of the contract
     * @param pricemonitorApiQuery The body contains the products query. Note that the support for the query field is currently limited. The only allowed pattern is currently: The maximum allowed limit is (TODO needs investigation and enforcement before making the endpoint public) {   \&quot;pagination\&quot;: {     \&quot;start\&quot;: ${start},     \&quot;limit\&quot;: ${limit}   },   \&quot;filter\&quot;: {     \&quot;oneOf\&quot;: {       \&quot;field\&quot;: \&quot;customerProductId\&quot;,       \&quot;values\&quot;: [${customerProductIds as a list of strings}]     }   } } 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    ...
    /**
     * @param contractId ID of the contract
     * @param queryProductsRequestV3 The body contains the products query. Note that the support for the query field is currently limited. The only allowed pattern is currently: The maximum allowed limit is (TODO needs investigation and enforcement before making the endpoint public) {   \&quot;pagination\&quot;: {     \&quot;start\&quot;: ${start},     \&quot;limit\&quot;: ${limit}   },   \&quot;filter\&quot;: {     \&quot;oneOf\&quot;: {       \&quot;field\&quot;: \&quot;customerProductId\&quot;,       \&quot;values\&quot;: [${customerProductIds as a list of strings}]     }   } } 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
