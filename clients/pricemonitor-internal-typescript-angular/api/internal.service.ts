...
export class InternalService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiV3VendorContractsContractIdOrdersStatsQueryPost(contractId: string, pricemonitorPostOrderStatisticsRequestV3: PricemonitorPostOrderStatisticsRequestV3, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<QueryOrderStatisticsV3ApiResponse>;
    public apiV3VendorContractsContractIdOrdersStatsQueryPost(contractId: string, pricemonitorPostOrderStatisticsRequestV3: PricemonitorPostOrderStatisticsRequestV3, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<QueryOrderStatisticsV3ApiResponse>>;
    public apiV3VendorContractsContractIdOrdersStatsQueryPost(contractId: string, pricemonitorPostOrderStatisticsRequestV3: PricemonitorPostOrderStatisticsRequestV3, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<QueryOrderStatisticsV3ApiResponse>>;
    public apiV3VendorContractsContractIdOrdersStatsQueryPost(contractId: string, pricemonitorPostOrderStatisticsRequestV3: PricemonitorPostOrderStatisticsRequestV3, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        if (contractId === null || contractId === undefined) {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiV3VendorContractsContractIdSettingsPricingstrategiesScenariosPost(contractId: string, postScenarioStrategyRequest?: PostScenarioStrategyRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<PostScenarioStrategyResponseApiResponse>;
    public apiV3VendorContractsContractIdSettingsPricingstrategiesScenariosPost(contractId: string, postScenarioStrategyRequest?: PostScenarioStrategyRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<PostScenarioStrategyResponseApiResponse>>;
    public apiV3VendorContractsContractIdSettingsPricingstrategiesScenariosPost(contractId: string, postScenarioStrategyRequest?: PostScenarioStrategyRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<PostScenarioStrategyResponseApiResponse>>;
    public apiV3VendorContractsContractIdSettingsPricingstrategiesScenariosPost(contractId: string, postScenarioStrategyRequest?: PostScenarioStrategyRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        if (contractId === null || contractId === undefined) {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public controlpanelApiV3DomainsPost(pricemonitorPostAdminAddDomainBodyV3?: PricemonitorPostAdminAddDomainBodyV3, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<PostAdminAddDomainV3ApiResponse>;
    public controlpanelApiV3DomainsPost(pricemonitorPostAdminAddDomainBodyV3?: PricemonitorPostAdminAddDomainBodyV3, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<PostAdminAddDomainV3ApiResponse>>;
    public controlpanelApiV3DomainsPost(pricemonitorPostAdminAddDomainBodyV3?: PricemonitorPostAdminAddDomainBodyV3, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<PostAdminAddDomainV3ApiResponse>>;
    public controlpanelApiV3DomainsPost(pricemonitorPostAdminAddDomainBodyV3?: PricemonitorPostAdminAddDomainBodyV3, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
