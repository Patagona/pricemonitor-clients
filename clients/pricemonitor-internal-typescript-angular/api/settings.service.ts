...
export class SettingsService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getCallbacksVendorV2(contractId: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<PricemonitorCallbacks>;
    public getCallbacksVendorV2(contractId: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<PricemonitorCallbacks>>;
    public getCallbacksVendorV2(contractId: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<PricemonitorCallbacks>>;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public putCallbacksVendorV2(contractId: string, pricemonitorCallbacks?: PricemonitorCallbacks, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<PricemonitorCallbacks>;
    public putCallbacksVendorV2(contractId: string, pricemonitorCallbacks?: PricemonitorCallbacks, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<PricemonitorCallbacks>>;
    public putCallbacksVendorV2(contractId: string, pricemonitorCallbacks?: PricemonitorCallbacks, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<PricemonitorCallbacks>>;
    public putCallbacksVendorV2(contractId: string, pricemonitorCallbacks?: PricemonitorCallbacks, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        if (contractId === null || contractId === undefined) {
