...
export class OffersService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getOffersManufacturerV3(contractId: string, start?: number, limit?: number, includeTags?: boolean, startDate?: string, endDate?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<GetOffersApiResponse>;
    public getOffersManufacturerV3(contractId: string, start?: number, limit?: number, includeTags?: boolean, startDate?: string, endDate?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<GetOffersApiResponse>>;
    public getOffersManufacturerV3(contractId: string, start?: number, limit?: number, includeTags?: boolean, startDate?: string, endDate?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<GetOffersApiResponse>>;
    public getOffersManufacturerV3(contractId: string, start?: number, limit?: number, includeTags?: boolean, startDate?: string, endDate?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        if (contractId === null || contractId === undefined) {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getOffersVendorV3(contractId: string, start?: number, limit?: number, includeTags?: boolean, startDate?: string, endDate?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<GetOffersApiResponse>;
    public getOffersVendorV3(contractId: string, start?: number, limit?: number, includeTags?: boolean, startDate?: string, endDate?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<GetOffersApiResponse>>;
    public getOffersVendorV3(contractId: string, start?: number, limit?: number, includeTags?: boolean, startDate?: string, endDate?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<GetOffersApiResponse>>;
    public getOffersVendorV3(contractId: string, start?: number, limit?: number, includeTags?: boolean, startDate?: string, endDate?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        if (contractId === null || contractId === undefined) {
     ...
     * @param contractId Unique identifier of the contract
     * @param pricemonitorPostProductOfferRequest A list of individual POST offers requests (snapshots) to be stored.  Submit up to 1,000 snapshots per request for optimal performance. Snapshots are validated and processed in the order provided. The response follows the same order. 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public postOffersInABulkVendorV2(contractId: string, pricemonitorPostProductOfferRequest: Array<PricemonitorPostProductOfferRequest>, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<BooleanBulkApiResponse>;
    public postOffersInABulkVendorV2(contractId: string, pricemonitorPostProductOfferRequest: Array<PricemonitorPostProductOfferRequest>, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<BooleanBulkApiResponse>>;
    public postOffersInABulkVendorV2(contractId: string, pricemonitorPostProductOfferRequest: Array<PricemonitorPostProductOfferRequest>, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<BooleanBulkApiResponse>>;
    public postOffersInABulkVendorV2(contractId: string, pricemonitorPostProductOfferRequest: Array<PricemonitorPostProductOfferRequest>, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        ...
        return this.httpClient.post<BooleanBulkApiResponse>(`${this.configuration.basePath}/api/2/v/contracts/${encodeURIComponent(String(contractId))}/offers`,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public queryOffersStatsVendorV31(contractId: string, pricemonitorPostOfferStatisticsRequestV31?: PricemonitorPostOfferStatisticsRequestV31, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<QueryOfferStatisticsV31ApiResponse>;
    public queryOffersStatsVendorV31(contractId: string, pricemonitorPostOfferStatisticsRequestV31?: PricemonitorPostOfferStatisticsRequestV31, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<QueryOfferStatisticsV31ApiResponse>>;
    public queryOffersStatsVendorV31(contractId: string, pricemonitorPostOfferStatisticsRequestV31?: PricemonitorPostOfferStatisticsRequestV31, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<QueryOfferStatisticsV31ApiResponse>>;
    public queryOffersStatsVendorV31(contractId: string, pricemonitorPostOfferStatisticsRequestV31?: PricemonitorPostOfferStatisticsRequestV31, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        if (contractId === null || contractId === undefined) {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public queryOffersVendorV3(contractId: string, productOffersApiQuery: ProductOffersApiQuery, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<QueryOffersApiResponse>;
    public queryOffersVendorV3(contractId: string, productOffersApiQuery: ProductOffersApiQuery, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<QueryOffersApiResponse>>;
    public queryOffersVendorV3(contractId: string, productOffersApiQuery: ProductOffersApiQuery, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<QueryOffersApiResponse>>;
    public queryOffersVendorV3(contractId: string, productOffersApiQuery: ProductOffersApiQuery, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        if (contractId === null || contractId === undefined) {
