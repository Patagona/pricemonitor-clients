 ...
 *
 * The version of the OpenAPI document: 0.0.5167
 * 
 *
...
import { ComPatagonaPricemonitorShareApiPostPasswordResetRequest } from '../model/models';
...
export class AccountService {
    ...
    /**
     * @param comPatagonaPricemonitorShareApiPostPasswordResetRequest Request a new password.
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public requestNewPassword(comPatagonaPricemonitorShareApiPostPasswordResetRequest?: ComPatagonaPricemonitorShareApiPostPasswordResetRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json'}): Observable<string>;
    public requestNewPassword(comPatagonaPricemonitorShareApiPostPasswordResetRequest?: ComPatagonaPricemonitorShareApiPostPasswordResetRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json'}): Observable<HttpResponse<string>>;
    public requestNewPassword(comPatagonaPricemonitorShareApiPostPasswordResetRequest?: ComPatagonaPricemonitorShareApiPostPasswordResetRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json'}): Observable<HttpEvent<string>>;
    public requestNewPassword(comPatagonaPricemonitorShareApiPostPasswordResetRequest?: ComPatagonaPricemonitorShareApiPostPasswordResetRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json'}): Observable<any> {
        ...
        return this.httpClient.post<string>(`${this.configuration.basePath}/api/account/password/reset`,
            comPatagonaPricemonitorShareApiPostPasswordResetRequest,
            {
                responseType: <any>responseType,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public resetPassword(body?: object, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<object>;
    public resetPassword(body?: object, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<object>>;
    public resetPassword(body?: object, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<object>>;
    public resetPassword(body?: object, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        ...
        return this.httpClient.put<object>(`${this.configuration.basePath}/api/account/password/reset`,
            body,
            {
                responseType: <any>responseType,
                withCredentials: this.configuration.withCredentials,
