 ...
 *
 * The version of the OpenAPI document: 0.0.5164
 * 
 *
...
export class AccountService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public requestNewPassword(body?: object, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<object>;
    public requestNewPassword(body?: object, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<object>>;
    public requestNewPassword(body?: object, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<object>>;
    public requestNewPassword(body?: object, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        ...
        return this.httpClient.post<object>(`${this.configuration.basePath}/api/account/password/reset`,
            body,
            {
                responseType: <any>responseType,
                withCredentials: this.configuration.withCredentials,
