...
import { PricemonitorPostAmazonBuyboxProductsStatsRequestV3 } from '../model/models';
...
export class ProductsService {
     ...
     * @param contractId ID of the contract
     * @param pricemonitorPostAmazonBuyboxProductsStatsRequestV3 Request body contains list of product identifiers, start date time and end date time. Endpoint searches for latest Amazon Buybox product statistics with product identifiers in the given time range defined by [start date, end date]. 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public postAmazonBuyboxProductStatsV3(contractId: string, pricemonitorPostAmazonBuyboxProductsStatsRequestV3?: PricemonitorPostAmazonBuyboxProductsStatsRequestV3, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<AmazonBuyboxProductStatsV3ApiResponse>;
    public postAmazonBuyboxProductStatsV3(contractId: string, pricemonitorPostAmazonBuyboxProductsStatsRequestV3?: PricemonitorPostAmazonBuyboxProductsStatsRequestV3, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<AmazonBuyboxProductStatsV3ApiResponse>>;
    public postAmazonBuyboxProductStatsV3(contractId: string, pricemonitorPostAmazonBuyboxProductsStatsRequestV3?: PricemonitorPostAmazonBuyboxProductsStatsRequestV3, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<AmazonBuyboxProductStatsV3ApiResponse>>;
    public postAmazonBuyboxProductStatsV3(contractId: string, pricemonitorPostAmazonBuyboxProductsStatsRequestV3?: PricemonitorPostAmazonBuyboxProductsStatsRequestV3, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        if (contractId === null || contractId === undefined) {
            throw new Error('Required parameter contractId was null or undefined when calling postAmazonBuyboxProductStatsV3.');
        }
        ...
        return this.httpClient.post<AmazonBuyboxProductStatsV3ApiResponse>(`${this.configuration.basePath}/api/v3/vendor/contracts/${encodeURIComponent(String(contractId))}/products/amazon/buybox/stats`,
            pricemonitorPostAmazonBuyboxProductsStatsRequestV3,
            {
                responseType: <any>responseType,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
