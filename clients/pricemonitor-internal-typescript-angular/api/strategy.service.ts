...
export class StrategyService {
     ...
     */
    public getPricingStrategyHistory(contractId: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<GetPricingStrategyHistoryApiResponse>;
    public getPricingStrategyHistory(contractId: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<GetPricingStrategyHistoryApiResponse>>;
    public getPricingStrategyHistory(contractId: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<GetPricingStrategyHistoryApiResponse>>;
    public getPricingStrategyHistory(contractId: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
