 ...
 */
import { ComPatagonaPricemonitorShareApiProductMonitoringStatusOnDomainOutcome } from './comPatagonaPricemonitorShareApiProductMonitoringStatusOnDomainOutcome';


/**
 * Describes the monitoring status of a product on a certain domain.
 */
export interface ComPatagonaPricemonitorShareApiProductMonitoringStatusOnDomain { 
    /**
