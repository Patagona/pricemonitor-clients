...
class PluginregistrationApi(baseUrl: String)(implicit serializer: SttpSerializer) {
   ...
   */
  def deletePluginRegistration(contractId: String)(implicit basicAuth: BasicCredentials): ApiRequestT[PluginRegistrationEmptyApiResponse] =
    basicRequest
   ...
   * @param contractId ID of the contract
   */
  def getPluginRegistration(contractId: String)(implicit basicAuth: BasicCredentials): ApiRequestT[PluginRegistrationApiResponse] =
    basicRequest
   ...
   */
  def putPluginRegistration(contractId: String, putPluginRegistrationRequest: PutPluginRegistrationRequest)(implicit basicAuth: BasicCredentials): ApiRequestT[PluginRegistrationEmptyApiResponse] =
    basicRequest
