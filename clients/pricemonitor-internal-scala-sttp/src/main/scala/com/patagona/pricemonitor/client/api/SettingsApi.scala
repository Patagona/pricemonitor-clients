  ...
  def getCallbacks(contractId: String)(implicit basicAuth: Option[BasicCredentials], bearerToken: Option[BearerToken]): ApiRequestT[Callbacks] =
{
   ...
   * 
   * Expected answers:
   *   code 200 : Callbacks (Returns a list of all configured callbacks for certain events. These callbacks are executed once the respective event has been successfully completed. )
   *   code 404 :  (Contract settings for this contract don't exist yet.)
   * 
   * Available security schemes:
   *   BasicAuth (http)
   *   BearerAuth (http)
   ...
   * @param contractId ID of the contract
   */
  def getCallbacksVendorV2(contractId: String)(implicit basicAuth: Option[BasicCredentials], bearerToken: Option[BearerToken]): ApiRequestT[Callbacks] =
{
    var r = basicRequest
  ...
  def putCallbacks(contractId: String, callbacks: Callbacks)(implicit basicAuth: Option[BasicCredentials], bearerToken: Option[BearerToken]): ApiRequestT[Unit] =
{
   ...
   * 
   * Expected answers:
   *   code 200 : Callbacks (Returns the callbacks that have been successfully stored.)
   *   code 404 :  (Contract settings for this contract don't exist yet)
   * 
   * Available security schemes:
   *   BasicAuth (http)
   ...
   * 
   * @param contractId ID of the contract
   * @param callbacks The request body should contain a list of callbacks to be stored.
   */
  def putCallbacksVendorV2(contractId: String, callbacks: Option[Callbacks] = None)(implicit basicAuth: Option[BasicCredentials], bearerToken: Option[BearerToken]): ApiRequestT[Callbacks] =
{
    var r = basicRequest
  ...
  def putCustomerContractSettingsVendorV3(contractId: String, customerContractSettings: Option[CustomerContractSettings] = None)(implicit basicAuth: Option[BasicCredentials], bearerToken: Option[BearerToken]): ApiRequestT[PutCustomerContractSettingsApiResponse] =
{
   ...
   */
  def putDomains(contractId: String, requestBody: Seq[String])(implicit basicAuth: Option[BasicCredentials], bearerToken: Option[BearerToken]): ApiRequestT[Unit] =
{
    var r = basicRequest
