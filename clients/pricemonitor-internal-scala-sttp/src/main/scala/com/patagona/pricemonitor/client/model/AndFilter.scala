...
case class AndFilter(
  filters: Option[Seq[OneOfOrFilterAndFilterNotFilterConstantFilterComparisonFilter]] = None,
  `type`: AndFilterEnums.`Type`
) extends ApiModel

object AndFilterEnums {

  type `Type` = `Type`.Value
  object `Type` extends Enumeration {
    val AndFilter = Value("AndFilter")
  }
