...
class UndocumentedApi(baseUrl: String)(implicit serializer: SttpSerializer) {
   ...
   *   BearerAuth (http)
   */
  def authenticate()(implicit basicAuth: BasicCredentials, bearerToken: BearerToken): ApiRequestT[Any] =
    basicRequest
   ...
   *   BearerAuth (http)
   */
  def logout()(implicit basicAuth: BasicCredentials, bearerToken: BearerToken): ApiRequestT[Any] =
    basicRequest
