...
class CompaniesApi(baseUrl: String)(implicit serializer: SttpSerializer) {
   ...
   */
  def addCompanyContract(companyId: Long, createContractRequest: CreateContractRequest)(implicit basicAuth: BasicCredentials): ApiRequestT[AddCompanyContractApiResponse] =
    basicRequest
   ...
   */
  def createCompany(body: String)(implicit basicAuth: BasicCredentials): ApiRequestT[CreateCompanyApiResponse] =
    basicRequest
   ...
   * @param companyId 
   */
  def getCompanyContracts(companyId: Long)(implicit basicAuth: BasicCredentials): ApiRequestT[GetCompanyContractsApiResponse] =
    basicRequest
