...
class AccountApi(baseUrl: String)(implicit serializer: SttpSerializer) {
   ...
   */
  def postAccountV3(postAccountRequestV3: Option[PostAccountRequestV3] = None)(implicit basicAuth: BasicCredentials, bearerToken: BearerToken): ApiRequestT[PostAccountResponseV3ApiResponse] =
    basicRequest
