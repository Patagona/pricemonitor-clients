...
class AccountApi(baseUrl: String)(implicit serializer: SttpSerializer) {
   ...
   * @param token 
   */
  def checkUserConfirmation(token: String)(implicit basicAuth: BasicCredentials): ApiRequestT[Unit] =
    basicRequest
   ...
   */
  def confirmUser(token: String, body: String)(implicit basicAuth: BasicCredentials): ApiRequestT[Unit] =
    basicRequest
   ...
   */
  def postAccountV3(postAccountRequestV3: Option[PostAccountRequestV3] = None)(implicit basicAuth: BasicCredentials): ApiRequestT[PostAccountResponseV3ApiResponse] =
    basicRequest
   ...
   *   BasicAuth (http)
   */
  def userInfo()(implicit basicAuth: BasicCredentials): ApiRequestT[UserInfo] =
    basicRequest
   ...
   */
  def userSignup(userSignupRequest: UserSignupRequest)(implicit basicAuth: BasicCredentials): ApiRequestT[Unit] =
    basicRequest
