...
class JobsApi(baseUrl: String)(implicit serializer: SttpSerializer) {
   ...
   * @param job 
   */
  def createJob(contractId: String, job: Option[Job] = None): ApiRequestT[JobApiResponse] =
{
    var r = basicRequest
   ...
   * @param contractId Each job must have a `contractId`
   */
  def deleteJob(jobId: String, contractId: String): ApiRequestT[JobApiResponse] =
{
    var r = basicRequest
   ...
   */
  def getContractJobs(contractId: String, jobType: Option[String] = None): ApiRequestT[JobsApiResponse] =
{
    var r = basicRequest
   ...
   * @param contractId Each job must have a `contractId`
   */
  def getDkronExecutions(jobId: String, contractId: String): ApiRequestT[DkronExecutionsApiResponse] =
{
    var r = basicRequest
   ...
   * @param contractId Each job must have a `contractId`
   */
  def getDkronJob(jobId: String, contractId: String): ApiRequestT[DkronJobApiResponse] =
{
    var r = basicRequest
   ...
   * @param contractId Each job must have a `contractId`
   */
  def getJob(jobId: String, contractId: String): ApiRequestT[JobApiResponse] =
{
    var r = basicRequest
   ...
   * @param job 
   */
  def updateJob(jobId: String, contractId: String, job: Option[Job] = None): ApiRequestT[JobApiResponse] =
{
    var r = basicRequest
