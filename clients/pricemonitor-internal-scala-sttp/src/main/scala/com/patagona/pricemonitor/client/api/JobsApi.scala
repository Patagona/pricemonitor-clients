  ...
  def deleteJob(jobId: String, contractId: String)(implicit basicAuth: Option[BasicCredentials], bearerToken: Option[BearerToken]): ApiRequestT[JobApiResponse] =
{
   ...
   */
  def getContractJobs(contractId: String, jobType: Option[String] = None)(implicit basicAuth: Option[BasicCredentials], bearerToken: Option[BearerToken]): ApiRequestT[JobsApiResponse] =
{
    var r = basicRequest
