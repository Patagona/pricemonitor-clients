...
class TasksApi(baseUrl: String)(implicit serializer: SttpSerializer) {
   ...
   */
  def getTaskVendorV2(contractId: String, taskId: String)(implicit basicAuth: BasicCredentials): ApiRequestT[TaskWithContractResourceApiResponse] =
    basicRequest
   ...
   */
  def getTasksVendorV2(contractId: String, taskIdsFilter: Option[String] = None, taskTypeFilter: Option[String] = None, limit: Option[Int] = None, includeFailures: Option[Boolean] = None, taskState: Option[String] = None, minCreationDate: Option[OffsetDateTime] = None, maxCreationDate: Option[OffsetDateTime] = None)(implicit basicAuth: BasicCredentials): ApiRequestT[Set[TaskWithContractResourceApiResponse]] =
    basicRequest
