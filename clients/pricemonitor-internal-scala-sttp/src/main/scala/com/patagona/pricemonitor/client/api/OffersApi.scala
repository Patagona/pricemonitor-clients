 ...
 *
 * The version of the OpenAPI document: 0.0.5531
 * 
 *
...
class OffersApi(baseUrl: String)(implicit serializer: SttpSerializer) {
   ...
   */
  def apiV3ManufacturerContractsContractIdOffersGet(contractId: String, start: Option[Int] = None, limit: Option[Int] = None, startDate: Option[OffsetDateTime] = None, endDate: Option[OffsetDateTime] = None)(implicit basicAuth: BasicCredentials): ApiRequestT[GetOffersApiResponse] =
    basicRequest
   ...
   * @param endDate Timestamp of end of time range, formatted as ISO Date (i.e. 2018-04-06T13:46:13Z) in UTC. If this value is omitted, the range is '{startDate} to {startDate} + 48 hours' if {startDate} is given or NOW - 48 hours if both are omitted.
   */
  def apiV3VendorContractsContractIdOffersGet(contractId: String, start: Option[Int] = None, limit: Option[Int] = None, startDate: Option[OffsetDateTime] = None, endDate: Option[OffsetDateTime] = None)(implicit basicAuth: BasicCredentials): ApiRequestT[GetOffersApiResponse] =
    basicRequest
   ...
   */
  def apiV3VendorContractsContractIdOffersQueryPost(contractId: String, productOffersApiQuery: ProductOffersApiQuery)(implicit basicAuth: BasicCredentials): ApiRequestT[QueryOffersApiResponse] =
    basicRequest
   ...
   */
  def getCheapestVendorsManufacturerV2(contractId: String, session: OffsetDateTime, includeDeliveryCosts: Boolean, body: Option[Any] = None)(implicit basicAuth: BasicCredentials): ApiRequestT[Any] =
    basicRequest
   ...
   * @param body This is a generated entry and needs to be described.
   */
  def getVendorsByDomainManufacturerV2(contractId: String, domain: String, start: Int, includeDeliveryCosts: Boolean, session: OffsetDateTime, body: Option[Any] = None)(implicit basicAuth: BasicCredentials): ApiRequestT[Any] =
    basicRequest
  ...
  /**
   * Expected answers:
   *   code 200 : PricesByDayByProductIdResponseV2 (The list of all known prices for the queried day & product ID)
   * 
   * Available security schemes:
   *   BasicAuth (http)
   * 
   ...
   */
  def pricesByDayByProductIdManufacturerV2(contractId: String, productId: String, pricesByDayByProductIdRequestV2: Option[PricesByDayByProductIdRequestV2] = None)(implicit basicAuth: BasicCredentials): ApiRequestT[PricesByDayByProductIdResponseV2] =
    basicRequest
      ...
      .response(asJson[PricesByDayByProductIdResponseV2])
   ...
   * @param body This is a generated entry and needs to be described.
   */
  def vendorsPerDomainManufacturerV2(contractId: String, session: OffsetDateTime, body: Option[Any] = None)(implicit basicAuth: BasicCredentials): ApiRequestT[Any] =
    basicRequest
