...
class OffersApi(baseUrl: String)(implicit serializer: SttpSerializer) {
   ...
   */
  def apiV3ManufacturerContractsContractIdOffersGet(contractId: String, start: Option[Int] = None, limit: Option[Int] = None, startDate: Option[OffsetDateTime] = None, endDate: Option[OffsetDateTime] = None)(implicit basicAuth: Option[BasicCredentials], bearerToken: Option[BearerToken]): ApiRequestT[GetOffersApiResponse] =
{
    var r = basicRequest
  ...
  def apiV3ManufacturerContractsContractIdOffersShopsGet(contractId: String, startDate: Option[OffsetDateTime] = None, endDate: Option[OffsetDateTime] = None)(implicit basicAuth: Option[BasicCredentials], bearerToken: Option[BearerToken]): ApiRequestT[GetShopsByDomainResponseV3ApiResponse] =
{
   ...
   * @param endDate Timestamp of end of time range, formatted as ISO Date (i.e. 2018-04-06T13:46:13Z) in UTC. If this value is omitted and {startDate} is given, {endDate} is set to {startDate} + 48 hours. If both values are omitted, the range is 'NOW - 48 hours to NOW'.
   */
  def apiV3VendorContractsContractIdOffersGet(contractId: String, start: Option[Int] = None, limit: Option[Int] = None, startDate: Option[OffsetDateTime] = None, endDate: Option[OffsetDateTime] = None)(implicit basicAuth: Option[BasicCredentials], bearerToken: Option[BearerToken]): ApiRequestT[GetOffersApiResponse] =
{
    var r = basicRequest
