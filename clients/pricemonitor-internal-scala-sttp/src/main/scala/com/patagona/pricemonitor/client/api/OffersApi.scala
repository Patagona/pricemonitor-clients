  ...
  def getOffers(contractId: String, start: Int, limit: Int, startDate: Option[OffsetDateTime] = None, endDate: Option[OffsetDateTime] = None)(implicit basicAuth: Option[BasicCredentials], bearerToken: Option[BearerToken]): ApiRequestT[GetOffersResponse] =
{
   ...
   * @param limit Maximum number of offers to return (max 10,000)
   * @param includeTags Whether to include product tags in the response
   * @param startDate **Start of time range** for data retrieval.  Format: ISO 8601 date-time in UTC (e.g., `2024-01-15T10:30:00Z`)  **Default behavior:** - If omitted and `endDate` is provided: `startDate` = `endDate` - 48 hours - If both omitted: range is `NOW - 48 hours` to `NOW` 
   * @param endDate **End of time range** for data retrieval.  Format: ISO 8601 date-time in UTC (e.g., `2024-01-16T10:30:00Z`)  **Default behavior:** - If omitted and `startDate` is provided: `endDate` = `startDate` + 48 hours - If both omitted: range is `NOW - 48 hours` to `NOW` 
   */
  def getOffersManufacturerV3(contractId: String, start: Option[Int] = None, limit: Option[Int] = None, includeTags: Option[Boolean] = None, startDate: Option[OffsetDateTime] = None, endDate: Option[OffsetDateTime] = None)(implicit basicAuth: Option[BasicCredentials], bearerToken: Option[BearerToken]): ApiRequestT[GetOffersApiResponse] =
{
    var r = basicRequest
  ...
  def getOffersShopsVendorV3(contractId: String, startDate: Option[OffsetDateTime] = None, endDate: Option[OffsetDateTime] = None)(implicit basicAuth: Option[BasicCredentials], bearerToken: Option[BearerToken]): ApiRequestT[GetShopsByDomainResponseV3ApiResponse] =
{
   ...
   * @param endDate **End of time range** for data retrieval.  Format: ISO 8601 date-time in UTC (e.g., `2024-01-16T10:30:00Z`)  **Default behavior:** - If omitted and `startDate` is provided: `endDate` = `startDate` + 48 hours - If both omitted: range is `NOW - 48 hours` to `NOW` 
   */
  def getOffersVendorV3(contractId: String, start: Option[Int] = None, limit: Option[Int] = None, includeTags: Option[Boolean] = None, startDate: Option[OffsetDateTime] = None, endDate: Option[OffsetDateTime] = None)(implicit basicAuth: Option[BasicCredentials], bearerToken: Option[BearerToken]): ApiRequestT[GetOffersApiResponse] =
{
    var r = basicRequest
  ...
  def positionDistribution(contractId: String, vendor: String, day: OffsetDateTime, body: Option[Any] = None)(implicit basicAuth: Option[BasicCredentials], bearerToken: Option[BearerToken]): ApiRequestT[Any] =
{
   ...
   * 
   * @param contractId Unique identifier of the contract
   * @param postProductOfferRequest A list of individual POST offers requests (snapshots) to be stored.  Submit up to 1,000 snapshots per request for optimal performance. Snapshots are validated and processed in the order provided. The response follows the same order. 
   */
  def postOffersInABulkVendorV2(contractId: String, postProductOfferRequest: Seq[PostProductOfferRequest])(implicit basicAuth: Option[BasicCredentials], bearerToken: Option[BearerToken]): ApiRequestT[BooleanBulkApiResponse] =
{
    var r = basicRequest
  ...
  def queryOffersStatsManufacturerV31(contractId: String, postOfferStatisticsRequestV31: Option[PostOfferStatisticsRequestV31] = None)(implicit basicAuth: Option[BasicCredentials], bearerToken: Option[BearerToken]): ApiRequestT[QueryOfferStatisticsV31ApiResponse] =
{
   ...
   * @param postOfferStatisticsRequestV31 The request body may include an optional products query. If omitted, all products are queried. Currently, product queries can be performed on two attributes:   - \"customerProductId\"   - \"productId\" (Patagona's internal product id; must be a numerical integer)  Pagination is supported with a maximum limit of 10,000. For optimized performance:   - Use a limit of 10,000 products per page when querying all products of a contract.   - Prefer using \"productId\" for queries when a product query is utilized.  Pagination operates based on the provided products query. This is particularly useful when querying a set of customerProductId's. For chunked requests over a set of ids, it's straightforward to specify up to 10,000 customerProductId's in the query with pagination set at start: 0, limit: 10,000. The allowed query pattern is structured as follows: ``` json {   \"pagination\": {     \"start\": ${start},     \"limit\": ${limit}   },   \"range\": {     \"start\": ${start},     \"end\": ${end}   },   \"filter\": {     \"oneOf\": {       \"field\": \"customerProductId\",       \"values\": [${customerProductIds as a list of strings}]     }   } } ```
   */
  def queryOffersStatsVendorV31(contractId: String, postOfferStatisticsRequestV31: Option[PostOfferStatisticsRequestV31] = None)(implicit basicAuth: Option[BasicCredentials], bearerToken: Option[BearerToken]): ApiRequestT[QueryOfferStatisticsV31ApiResponse] =
{
    var r = basicRequest
   ...
   */
  def queryOffersVendorV3(contractId: String, productOffersApiQuery: ProductOffersApiQuery)(implicit basicAuth: Option[BasicCredentials], bearerToken: Option[BearerToken]): ApiRequestT[QueryOffersApiResponse] =
{
    var r = basicRequest
