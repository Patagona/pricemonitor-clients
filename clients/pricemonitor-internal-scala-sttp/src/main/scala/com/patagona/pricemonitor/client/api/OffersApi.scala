...
class OffersApi(baseUrl: String)(implicit serializer: SttpSerializer) {
   ...
   * @param tagFilteredVendorsRequest This is a generated entry and needs to be described.
   */
  def vendorsPerDomainManufacturerV2(contractId: String, session: OffsetDateTime, tagFilteredVendorsRequest: Option[TagFilteredVendorsRequest] = None)(implicit basicAuth: BasicCredentials, bearerToken: BearerToken): ApiRequestT[Any] =
    basicRequest
