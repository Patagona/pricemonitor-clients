...
class OrdersApi(baseUrl: String)(implicit serializer: SttpSerializer) {
   ...
   */
  def apiV3VendorContractsContractIdOrdersDeleteQueryPost(contractId: String, deleteOrdersByQueryRequestV3: DeleteOrdersByQueryRequestV3)(implicit basicAuth: Option[BasicCredentials], bearerToken: Option[BearerToken]): ApiRequestT[DeletedItemsApiResponse] =
{
    var r = basicRequest
