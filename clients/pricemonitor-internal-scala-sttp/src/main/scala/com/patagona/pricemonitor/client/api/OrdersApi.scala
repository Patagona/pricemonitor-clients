...
class OrdersApi(baseUrl: String)(implicit serializer: SttpSerializer) {
   ...
   */
  def deleteOrders(contractId: String)(implicit basicAuth: BasicCredentials): ApiRequestT[DeleteOrdersApiResponse] =
    basicRequest
   ...
   */
  def postOrders(contractId: String, postCustomerOrdersRequestV2: PostCustomerOrdersRequestV2)(implicit basicAuth: BasicCredentials): ApiRequestT[PostOrdersBulkApiResponse] =
    basicRequest
