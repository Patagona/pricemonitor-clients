...
class InternalApi(baseUrl: String)(implicit serializer: SttpSerializer) {
  ...
  /**
   * Expected answers:
   *   code 200 : Seq[String] (A list of configured domains is returned.)
   * 
   * Available security schemes:
   *   BasicAuth (http)
   * 
   * @param contractId ID of the contract
   */
  def getDomainsVendorV2(contractId: String)(implicit basicAuth: BasicCredentials): ApiRequestT[Seq[String]] =
    basicRequest
   ...
   * @param body This is a generated entry and needs to be described.
   */
  def queryPriceRecommendationsVendorV2(contractId: String, body: Option[Any] = None)(implicit basicAuth: BasicCredentials): ApiRequestT[Any] =
    basicRequest
   ...
   * 
   * @param contractId ID of the contract
   * @param apiQuery The body contains the products query. Note that the support for the query field is currently limited. The only allowed pattern is currently: The maximum allowed limit is (TODO needs investigation and enforcement before making the endpoint public) {   \"pagination\": {     \"start\": ${start},     \"limit\": ${limit}   },   \"filter\": {     \"oneOf\": {       \"field\": \"customerProductId\",       \"values\": [${customerProductIds as a list of strings}]     }   } } 
   */
  def queryProductsManufacturerV3(contractId: String, apiQuery: Option[ApiQuery] = None)(implicit basicAuth: BasicCredentials): ApiRequestT[QueryProductsManufacturerV3ApiResponse] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/api/v3.1/manufacturer/contracts/${contractId}/products/query")
      .contentType("application/json")
      .auth.basic(basicAuth.user, basicAuth.password)
      .body(apiQuery)
      .response(asJson[QueryProductsManufacturerV3ApiResponse])
   ...
   */
  def queryProductsVendorV3(contractId: String, queryProductsRequestV3: Option[QueryProductsRequestV3] = None)(implicit basicAuth: BasicCredentials): ApiRequestT[QueryProductsVendorV3ApiResponse] =
    basicRequest
      .method(Method.POST, uri"$baseUrl/api/v3.1/vendor/contracts/${contractId}/products/query")
      .contentType("application/json")
      .auth.basic(basicAuth.user, basicAuth.password)
      .body(queryProductsRequestV3)
      .response(asJson[QueryProductsVendorV3ApiResponse])
