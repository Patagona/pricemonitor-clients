...
class InternalApi(baseUrl: String)(implicit serializer: SttpSerializer) {
   ...
   * @param token 
   */
  def loginByAuthToken(token: String)(implicit basicAuth: BasicCredentials, bearerToken: BearerToken): ApiRequestT[Any] =
    basicRequest
   ...
   *   BearerAuth (http)
   */
  def version()(implicit basicAuth: BasicCredentials, bearerToken: BearerToken): ApiRequestT[VersionApiResponse] =
    basicRequest
