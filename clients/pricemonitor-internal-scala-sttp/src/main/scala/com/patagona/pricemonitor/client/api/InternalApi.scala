  ...
  def getAlertSettings(contractId: String)(implicit basicAuth: Option[BasicCredentials], bearerToken: Option[BearerToken]): ApiRequestT[Any] =
{
   ...
   */
  def getAllCompanies(start: Option[Int] = None, limit: Option[Int] = None)(implicit basicAuth: Option[BasicCredentials], bearerToken: Option[BearerToken]): ApiRequestT[AdminCompanyV2] =
{
    var r = basicRequest
  ...
  def getProductPropertiesV3(contractId: String, productId: Long)(implicit basicAuth: Option[BasicCredentials], bearerToken: Option[BearerToken]): ApiRequestT[GetProductPropertiesV3ApiResponse] =
{
   ...
   * 
   * Expected answers:
   *   code 200 : Any (A list of distinct keys of all product properties.)
   * 
   * Available security schemes:
   *   BasicAuth (http)
   *   BearerAuth (http)
   ...
   * @param contractId ID of the contract
   */
  def getProductPropertyKeysV3(contractId: String)(implicit basicAuth: Option[BasicCredentials], bearerToken: Option[BearerToken]): ApiRequestT[Any] =
{
    var r = basicRequest
