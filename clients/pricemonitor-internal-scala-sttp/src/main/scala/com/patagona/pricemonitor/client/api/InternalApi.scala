...
class InternalApi(baseUrl: String)(implicit serializer: SttpSerializer) {
   ...
   */
  def deleteVendorShopMappingManufacturerV3(contractId: String, vendorId: Long)(implicit basicAuth: BasicCredentials): ApiRequestT[DeleteByNumericIdApiResponse] =
    basicRequest
   ...
   * @param vendorId ID of vendor shop mapping
   */
  def getVendorShopMappingManufacturerV3(contractId: String, vendorId: Long)(implicit basicAuth: BasicCredentials): ApiRequestT[VendorShopMappingV3ApiResponse] =
    basicRequest
   ...
   */
  def postVendorShopMappingManufacturerV3(contractId: String, postVendorShopMappingRequestV3: Option[PostVendorShopMappingRequestV3] = None)(implicit basicAuth: BasicCredentials): ApiRequestT[VendorShopMappingV3ApiResponse] =
    basicRequest
   ...
   */
  def putVendorShopMappingManufacturerV3(contractId: String, vendorId: Long, postVendorShopMappingRequestV3: Option[PostVendorShopMappingRequestV3] = None)(implicit basicAuth: BasicCredentials): ApiRequestT[VendorShopMappingV3ApiResponse] =
    basicRequest
