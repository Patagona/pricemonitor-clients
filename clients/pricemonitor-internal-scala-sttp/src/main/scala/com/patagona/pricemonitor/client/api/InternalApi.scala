  ...
  def apiV3VendorContractsContractIdOffersStatsQueryPost(contractId: String, postOfferStatisticsRequest: PostOfferStatisticsRequest)(implicit basicAuth: Option[BasicCredentials], bearerToken: Option[BearerToken]): ApiRequestT[PostOfferStatisticsApiResponse] =
{
   ...
   */
  def apiV3VendorContractsContractIdSettingsPricingstrategiesScenariosPost(contractId: String, postScenarioStrategyRequest: Option[PostScenarioStrategyRequest] = None)(implicit basicAuth: Option[BasicCredentials], bearerToken: Option[BearerToken]): ApiRequestT[PostScenarioStrategyResponseApiResponse] =
{
    var r = basicRequest
  ...
  def getAllPortals()(implicit basicAuth: Option[BasicCredentials], bearerToken: Option[BearerToken]): ApiRequestT[Unit] =
{
  ...
  /**
   * Expected answers:
   *   code 200 : Seq[ScenarioStrategyMetadataResponseApiResponse] (List of all strategy scenarios metadata)
   * 
   * Available security schemes:
   *   BasicAuth (http)
   *   BearerAuth (http)
  ...
  def getRepricingStrategyVendorV2(contractId: String, documentVersion: Option[Int] = None)(implicit basicAuth: Option[BasicCredentials], bearerToken: Option[BearerToken]): ApiRequestT[Any] =
{
  ...
  /**
   * Expected answers:
   *   code 200 : ScenarioStrategyResponse (A strategy scenario)
   *   code 404 : ApiErrorResponse (Strategy scenario with the provided Id was not found.)
   * 
   * Available security schemes:
   *   BasicAuth (http)
   *   BearerAuth (http)
