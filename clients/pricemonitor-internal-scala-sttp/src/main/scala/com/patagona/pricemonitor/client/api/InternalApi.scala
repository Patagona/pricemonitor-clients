...
class InternalApi(baseUrl: String)(implicit serializer: SttpSerializer) {
   ...
   * @param contractId ID of the contract
   */
  def get(contractId: String)(implicit basicAuth: BasicCredentials): ApiRequestT[Any] =
    basicRequest
   ...
   */
  def queryProductsManufacturerV3(contractId: String, queryProductsRequestV3: Option[QueryProductsRequestV3] = None)(implicit basicAuth: BasicCredentials): ApiRequestT[QueryProductsManufacturerV3ApiResponse] =
    basicRequest
   ...
   * @param contractId ID of the contract
   */
  def queryProductsManufacturerV31(contractId: String)(implicit basicAuth: BasicCredentials): ApiRequestT[Any] =
    basicRequest
   ...
   * @param contractId ID of the contract
   */
  def queryProductsVendorV31(contractId: String)(implicit basicAuth: BasicCredentials): ApiRequestT[Any] =
    basicRequest
   ...
   * @param body This is a generated entry and needs to be described.
   */
  def update(contractId: String, body: Option[Any] = None)(implicit basicAuth: BasicCredentials): ApiRequestT[Any] =
    basicRequest
