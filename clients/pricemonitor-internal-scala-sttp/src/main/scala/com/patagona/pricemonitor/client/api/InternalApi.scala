...
import com.patagona.pricemonitor.client.model.ContractSettings
...
import com.patagona.pricemonitor.client.model.GetContractSettingsApiResponse
...
import com.patagona.pricemonitor.client.model.PutContractSettingsApiResponse
...
class InternalApi(baseUrl: String)(implicit serializer: SttpSerializer) {
  ...
  /**
   * Expected answers:
   *   code 200 : GetContractSettingsApiResponse (Settings for this contract.)
   * 
   * Available security schemes:
   *   BasicAuth (http)
   * 
   * @param contractId ID of the contract
   */
  def getContractSettingsManufaturerV3(contractId: String)(implicit basicAuth: BasicCredentials): ApiRequestT[GetContractSettingsApiResponse] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/api/v3/manufacturer/contracts/${contractId}/settings")
      .contentType("application/json")
      .auth.basic(basicAuth.user, basicAuth.password)
      .response(asJson[GetContractSettingsApiResponse])
   ...
   * @param contractId ID of the contract
   */
  def getContractSettingsVendorV3(contractId: String)(implicit basicAuth: BasicCredentials): ApiRequestT[GetContractSettingsApiResponse] =
    basicRequest
      .method(Method.GET, uri"$baseUrl/api/v3/vendor/contracts/${contractId}/settings")
      .contentType("application/json")
      .auth.basic(basicAuth.user, basicAuth.password)
      .response(asJson[GetContractSettingsApiResponse])
  ...
  /**
   * Expected answers:
   *   code 200 : PutContractSettingsApiResponse (Settings for this contract.)
   * 
   * Available security schemes:
   *   BasicAuth (http)
   * 
   * @param contractId ID of the contract
   * @param contractSettings This is a generated entry and needs to be described.
   */
  def putContractSettingsManufacturerV3(contractId: String, contractSettings: Option[ContractSettings] = None)(implicit basicAuth: BasicCredentials): ApiRequestT[PutContractSettingsApiResponse] =
    basicRequest
      .method(Method.PUT, uri"$baseUrl/api/v3/manufacturer/contracts/${contractId}/settings")
      .contentType("application/json")
      .auth.basic(basicAuth.user, basicAuth.password)
      .body(contractSettings)
      .response(asJson[PutContractSettingsApiResponse])
   ...
   * @param contractSettings This is a generated entry and needs to be described.
   */
  def putContractSettingsVendorV3(contractId: String, contractSettings: Option[ContractSettings] = None)(implicit basicAuth: BasicCredentials): ApiRequestT[PutContractSettingsApiResponse] =
    basicRequest
      .method(Method.PUT, uri"$baseUrl/api/v3/vendor/contracts/${contractId}/settings")
      .contentType("application/json")
      .auth.basic(basicAuth.user, basicAuth.password)
      .body(contractSettings)
      .response(asJson[PutContractSettingsApiResponse])
