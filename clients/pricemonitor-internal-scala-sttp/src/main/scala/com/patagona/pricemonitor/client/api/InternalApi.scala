  ...
  def postEmbedSSOUrlManufacturer(contractId: String, postEmbedSSOUrlRequestV3: Option[PostEmbedSSOUrlRequestV3] = None)(implicit basicAuth: Option[BasicCredentials], bearerToken: Option[BearerToken]): ApiRequestT[EmbedSSOUrlResponseV3ApiResponse] =
{
   ...
   * @param postEmbedSSOUrlRequestV3 Payload for retrieving a signed embed SSO url using Looker API.
   */
  def postEmbedSSOUrlManufacturerForCompanies(companyId: Long, postEmbedSSOUrlRequestV3: Option[PostEmbedSSOUrlRequestV3] = None)(implicit basicAuth: Option[BasicCredentials], bearerToken: Option[BearerToken]): ApiRequestT[EmbedSSOUrlResponseV3ApiResponse] =
{
    var r = basicRequest
      .method(Method.POST, uri"$baseUrl/api/v3/manufacturer/companies/${companyId}/looker/sso/embed/url")
      .contentType("application/json")
      basicAuth.foreach(b => r = r.auth.basic(b.user, b.password))
      bearerToken.foreach(b => r = r.auth.bearer(b.token))
      r=r.body(postEmbedSSOUrlRequestV3)
   ...
   * @param postEmbedSSOUrlRequestV3 Payload for retrieving a signed embed SSO url using Looker API.
   */
  def postEmbedSSOUrlVendorForCompanies(companyId: Long, postEmbedSSOUrlRequestV3: Option[PostEmbedSSOUrlRequestV3] = None)(implicit basicAuth: Option[BasicCredentials], bearerToken: Option[BearerToken]): ApiRequestT[EmbedSSOUrlResponseV3ApiResponse] =
{
    var r = basicRequest
      .method(Method.POST, uri"$baseUrl/api/v3/vendor/companies/${companyId}/looker/sso/embed/url")
      .contentType("application/json")
      basicAuth.foreach(b => r = r.auth.basic(b.user, b.password))
      bearerToken.foreach(b => r = r.auth.bearer(b.token))
      r=r.body(postEmbedSSOUrlRequestV3)
   ...
   * @param postEmbedSSOUrlRequestV3 Payload for retrieving a signed embed SSO url using Looker API.
   */
  def postEmbedSSOUrlVendorForContracts(contractId: String, postEmbedSSOUrlRequestV3: Option[PostEmbedSSOUrlRequestV3] = None)(implicit basicAuth: Option[BasicCredentials], bearerToken: Option[BearerToken]): ApiRequestT[EmbedSSOUrlResponseV3ApiResponse] =
{
    var r = basicRequest
  ...
  def updateFeatureFlag(key: String, putFeatureFlagRequest: PutFeatureFlagRequest)(implicit basicAuth: Option[BasicCredentials], bearerToken: Option[BearerToken]): ApiRequestT[UpdateFeatureFlagApiResponse] =
{
   ...
   * 
   * Expected answers:
   *   code 200 : UpdateTaskRequestV2 (The task was successfully updated and the stored task document is returned.)
   *   code 400 : ApiErrorResponse (The task payload is invalid or the payload identifiers do not match the path parameters.)
   *   code 404 :  (No task with the supplied `contractId` and `taskId` exists.)
   * 
   * Available security schemes:
   *   BasicAuth (http)
   *   BearerAuth (http)
   ...
   */
  def updateTaskManufacturerV2(contractId: String, taskId: String, updateTaskRequestV2: UpdateTaskRequestV2)(implicit basicAuth: Option[BasicCredentials], bearerToken: Option[BearerToken]): ApiRequestT[UpdateTaskRequestV2] =
{
    var r = basicRequest
      ...
      r.response(asJson[UpdateTaskRequestV2])
}
   ...
   * 
   * Expected answers:
   *   code 200 : UpdateTaskRequestV2 (Task was updated successfully and the persisted task document is returned.)
   *   code 400 : ApiErrorResponse (The task payload is invalid or contains identifiers that do not match the path parameters.)
   *   code 404 :  (No task with the supplied `contractId` and `taskId` exists.)
   * 
   * Available security schemes:
   *   BasicAuth (http)
   ...
   * @param updateTaskRequestV2 Complete task document that should replace the existing stored task.
   */
  def updateTaskVendorV2(contractId: String, taskId: String, updateTaskRequestV2: UpdateTaskRequestV2)(implicit basicAuth: Option[BasicCredentials], bearerToken: Option[BearerToken]): ApiRequestT[UpdateTaskRequestV2] =
{
    var r = basicRequest
