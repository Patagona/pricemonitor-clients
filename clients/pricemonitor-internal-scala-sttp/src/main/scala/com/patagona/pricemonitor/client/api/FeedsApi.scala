...
class FeedsApi(baseUrl: String)(implicit serializer: SttpSerializer) {
   ...
   */
  def excludeFetchedFeedData(contractId: String, feedId: String)(implicit basicAuth: BasicCredentials): ApiRequestT[Feed] =
    basicRequest
   ...
   * @param feedId ID of the feed
   */
  def getFeed(contractId: String, feedId: String)(implicit basicAuth: BasicCredentials): ApiRequestT[Feed] =
    basicRequest
   ...
   */
  def getFeedExport(contractId: String, feedId: String, fileName: String)(implicit basicAuth: BasicCredentials): ApiRequestT[Feed] =
    basicRequest
   ...
   * @param fileName fileName
   */
  def getFeedExportDelta(contractId: String, feedId: String, fileName: String)(implicit basicAuth: BasicCredentials): ApiRequestT[Feed] =
    basicRequest
   ...
   * @param contractId ID of the contract
   */
  def getFeeds(contractId: String)(implicit basicAuth: BasicCredentials): ApiRequestT[Set[Feed]] =
    basicRequest
